...
(function(process) {
  (function(a) {
    ...
    function o(a, b, c, d) {
      ...
      if (!i) {
        ...
        if (!(j == k || xb.call(a, "constructor") && xb.call(b, "constructor") || Ra(j) && j instanceof j && Ra(k) && k instanceof k || !("constructor" in a && "constructor" in b)))
          return !1;
      }
      c || (c = []), d || (d = []);
    ...
    function y(b) {
      ...
      if (!d && "string" == typeof b)
        return c = new t(b), c[eb]();
      if (!d && b.length !== a)
        return c = new v(b), c[eb]();
      if (!d)
    ...
    function A(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && x(b) ? (b = z(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > Qc ? Qc : b) : b;
    }
    function B(a, b) {
      this.observer = a, this.parent = b;
    }
    function C(a, b) {
      return ac(a) || (a = fc), new Sc(b, a);
    }
    function D(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function G(a, b) {
      return new Xd(function(c) {
        var d = new Wb,
            e = new Xb;
        return e.setDisposable(d), d.setDisposable(a.subscribe(new cd(c, e, b))), e;
      }, a);
    }
    function H() {
      return !1;
    ...
    function O(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return Qa(e) && (e = Ic(e)), (hb(e) || gb(e)) && (e = Rc(e)), e;
      }).concatAll();
    }
    function P(a, b, c) {
      for (var d = 0,
    ...
    function V(a) {
      return a ? xc.isObservable(a) ? a : Qa(a) ? xc.fromPromise(a) : $(a) || Z(a) ? Dd.call(this, a) : Ra(a) ? Y.call(this, a) : hb(a) || gb(a) ? W.call(this, a) : Gb(a) ? X.call(this, a) : a : a;
    }
    function W(a) {
      return xc.from(a).flatMap(V).toArray();
    }
    function X(b) {
      function c(b, c) {
      ...
      for (var d = new b.constructor,
        ...
        var i = e[g],
            j = V.call(this, b[i]);
        j && xc.isObservable(j) ? c(j, i) : d[i] = b[i];
      }
      return xc.forkJoin.apply(xc, f).map(function() {
        return d;
      });
    }
    function Y(a) {
    ...
    function ea(a, b, c) {
      ...
      if ("[object NodeList]" === e || "[object HTMLCollection]" === e)
        for (var f = 0,
            g = a.length; g > f; f++)
          d.add(ea(a.item(f), b, c));
      else
        a && d.add(new da(a, b, c));
      return d;
    }
    function fa(a, b) {
      return function() {
        var c = arguments[0];
        return Ra(b) && (c = Ta(b).apply(null, arguments), c === Sa) ? a.onError(c.e) : void a.onNext(c);
      };
    }
    function ga(a, b, c) {
      return new Xd(function(d) {
        ...
        var f,
            ...
            i = !1,
            j = new Array(2);
        return new Pb(a.subscribe(function(a) {
          e(a, 0);
        }, function(a) {
          j[1] ? d.onError(a) : f = a;
        }, function() {
    ...
    function ha(a, b) {
      return a.groupJoin(this, b, Nc, function(a, b) {
        return b;
      });
    }
    function ia(a) {
      ...
      return new Xd(function(c) {
        var d = new $d,
            e = new Pb,
            f = new Yb(e);
        return c.onNext(Mb(d, f)), e.add(b.subscribe(function(a) {
          d.onNext(a);
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
        })), Qa(a) && (a = Ic(a)), e.add(a.subscribe(function(a) {
          d.onCompleted(), d = new $d, c.onNext(Mb(d, f));
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
      ...
      return new Xd(function(c) {
        function d() {
          ...
          e.setDisposable(i), i.setDisposable(b.take(1).subscribe(Ka, function(a) {
            ...
            h.onCompleted(), h = new $d, c.onNext(Mb(h, g)), d();
          }));
        }
        var e = new Xb,
            f = new Pb(e),
            g = new Yb(f),
            h = new $d;
        return c.onNext(Mb(h, g)), f.add(b.subscribe(function(a) {
          h.onNext(a);
        }, function(a) {
          h.onError(a), c.onError(a);
        }, function() {
    ...
    function ta(a, b, c) {
      return new Xd(function(d) {
        ...
        return e = a.materialize().timestamp(c).subscribe(function(a) {
          ...
          }), k = !f, f = !0), k && (null !== h ? d.onError(h) : (e = new Wb, g.setDisposable(e), e.setDisposable(c.scheduleRecursiveWithRelative(b, function(a) {
            var b,
                e,
                g,
                k;
 ...
 while (null !== g);
    ...
    function va(a, b, c) {
      var d,
          e;
      return Ra(b) ? e = b : (d = b, e = c), new Xd(function(b) {
        function c() {
    ...
    function wa(a, b, c) {
      return ac(c) || (c = jc), new Xd(function(d) {
        var e,
            f = new Xb,
            g = !1,
            h = 0,
    ...
    function ya(a, b) {
      return new Xd(function(c) {
        ...
        return h.setDisposable(a.subscribe(function(a) {
          ...
          f = !0, h.dispose();
        })), new Pb(h, b.subscribe(d, function(a) {
          c.onError(a);
        }, d));
      }, a);
    }
    function za(a, b, c, d) {
      return Ra(b) && (d = c, c = b, b = Wc()), d || (d = bd(new Wd)), new Xd(function(e) {
        function f(a) {
          var b = k,
              c = new Wb;
    ...
    var ab = Ja.NotSupportedError = function(a) {
    ...
    var bb = Ja.NotImplementedError = function(a) {
    ...
    var cb = Ja.helpers.notImplemented = function() {
      throw new bb;
    },
        db = Ja.helpers.notSupported = function() {
          throw new ab;
        },
        eb = "function" == typeof Symbol && Symbol.iterator || "_es6shim_iterator_";
    Ia.Set && "function" == typeof(new Ia.Set)["@@iterator"] && (eb = "@@iterator");
    var fb = Ja.doneEnumerator = {
      done: !0,
      value: a
    },
        gb = Ja.helpers.isIterable = function(b) {
          return b[eb] !== a;
        },
        hb = Ja.helpers.isArrayLike = function(b) {
          return b && b.length !== a;
        };
    Ja.helpers.iterator = eb;
    var ib,
        jb = Ja.internals.bindCallback = function(a, b, c) {
    ...
    var Gb = Ja.internals.isObject = function(a) {
      var b = typeof a;
    ...
    var Ib = Ja.internals.isEqual = function(a, b) {
      return o(a, b, [], []);
        ...
        Mb = Ja.internals.addRef = function(a, b) {
          return new Xd(function(c) {
            return new Pb(b.getDisposable(), a.subscribe(c));
          });
        };
    ...
    var Nb = Ja.internals.PriorityQueue = function(a) {
      this.items = new Array(a), this.length = 0;
    },
        Ob = Nb.prototype;
    Ob.isHigherPriority = function(a, b) {
      return this.items[a].compareTo(this.items[b]) < 0;
    }, Ob.percolate = function(a) {
    ...
    var Pb = Ja.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var Rb = Ja.Disposable = function(a) {
      this.isDisposed = !1, this.action = a || Ka;
    };
    Rb.prototype.dispose = function() {
      this.isDisposed || (this.action(), this.isDisposed = !0);
    };
    var Sb = Rb.create = function(a) {
      return new Rb(a);
    },
        Tb = Rb.empty = {dispose: Ka},
        Ub = Rb.isDisposable = function(a) {
          return a && Ra(a.dispose);
        },
        Vb = Rb.checkDisposed = function(a) {
          if (a.isDisposed)
            throw new $a;
        },
        Wb = Ja.SingleAssignmentDisposable = function() {
    ...
    var Xb = Ja.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var Yb = Ja.RefCountDisposable = function() {
      function a(a) {
      ...
      return a.prototype.dispose = function() {
        ...
        return this.isDisposed ? Tb : new a(this);
      }, b;
    }();
    r.prototype.dispose = function() {
      this.scheduler.scheduleWithState(this, s);
    };
    var Zb = Ja.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || Oa, this.disposable = new Wb;
    };
    ...
    !function(a) {
      function b(a, b) {
        function c(b) {
          function d(a, b) {
            return g ? f.remove(i) : h = !0, e(b, c), Tb;
          }
          var g = !1,
              h = !1,
      ...
      function c(a, b, c) {
        function d(b, e) {
          function h(a, b) {
            return i ? g.remove(k) : j = !0, f(b, d), Tb;
          }
          var i = !1,
              j = !1,
              k = a[c](b, e, h);
    ...
    var bc,
        cc,
        dc = Ja.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
        ...
        ec = $b.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new $b(Ma, a, db, db);
        }(),
        fc = $b.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.shift();
          ...
          function b(b, e) {
            var f = new Zb(this, b, e, this.now());
            if (c)
              c.push(f);
            else {
              c = [f];
    ...
    !function() {
      ...
      var h = RegExp("^" + String(wb).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
          i = "function" == typeof(i = Ha && Ga && Ha.setImmediate) && !h.test(i) && i;
      if (Ra(i))
        bc = function(b) {
          var c = e++;
        ...
        Ia.addEventListener ? Ia.addEventListener("message", c, !1) : Ia.attachEvent ? Ia.attachEvent("onmessage", c) : Ia.onmessage = c, bc = function(a) {
          var b = e++;
          return f[b] = a, Ia.postMessage(j + currentId, "*"), b;
        };
      } else if (Ia.MessageChannel) {
        var k = new Ia.MessageChannel;
        ...
        bc = "document" in Ia && "onreadystatechange" in Ia.document.createElement("script") ? function(b) {
          ...
          var c = e++;
          return f[c] = b, hc(function() {
            a(c);
          }, 0), c;
        };
    }();
    var jc = $b.timeout = $b["default"] = function() {
      function a(a, b) {
        var c = this,
            d = new Wb,
            e = bc(function() {
      ...
      return new $b(Ma, a, b, c);
        ...
        kc = function(a) {
          ...
          return Kb(e, a), e.prototype._clone = function(a) {
        ...
        lc = Ja.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return ac(a) || (a = ec), new Xd(function(c) {
        ...
        oc = lc.createOnCompleted = function() {
          ...
          return function() {
            return new lc("C", null, null, a, b, c);
          };
        }(),
        pc = Ja.Observer = function() {};
    pc.prototype.toNotifier = function() {
      var a = this;
      return function(b) {
        return b.accept(a);
      };
    }, pc.prototype.asObserver = function() {
      var a = this;
    ...
    }, pc.prototype.checked = function() {
      return new uc(this);
    };
    var qc = pc.create = function(a, b, c) {
      return a || (a = Ka), b || (b = Pa), c || (c = Ka), new tc(a, b, c);
    };
    pc.fromNotifier = function(a, b) {
      var c = jb(a, b, 1);
    ...
    }, pc.prototype.notifyOn = function(a) {
      return new wc(a, this);
    }, pc.prototype.makeSafe = function(a) {
      return new AnonymousSafeObserver(this._onNext, this._onError, this._onCompleted, a);
    };
    var rc,
        sc = Ja.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
          return Kb(b, a), b.prototype.next = cb, b.prototype.error = cb, b.prototype.completed = cb, b.prototype.onNext = function(a) {
        ...
        tc = Ja.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        uc = function(a) {
          ...
          return c.onNext = function(a) {
            this.checkAccess();
            var b = Ta(this._observer.onNext).call(this._observer, a);
            this._state = 0, b === Sa && d(b.e);
          }, c.onError = function(a) {
            this.checkAccess();
            var b = Ta(this._observer.onError).call(this._observer, a);
            this._state = 2, b === Sa && d(b.e);
          }, c.onCompleted = function() {
            this.checkAccess();
            var a = Ta(this._observer.onCompleted).call(this._observer);
            this._state = 2, a === Sa && d(a.e);
        ...
        vc = Ja.internals.ScheduledObserver = function(a) {
          function b(b, c) {
          ...
          return Kb(b, a), b.prototype.next = function(a) {
            ...
            !this.hasFaulted && this.queue.length > 0 && (a = !this.isAcquired, this.isAcquired = !0), a && this.disposable.setDisposable(this.scheduler.scheduleRecursiveWithState(this, function(a, b) {
              ...
              c = a.queue.shift();
              var e = Ta(c)();
              return e === Sa ? (a.queue = [], a.hasFaulted = !0, d(e.e)) : void b(a);
            }));
          }, b.prototype.dispose = function() {
        ...
        wc = function(a) {
          ...
          return Kb(b, a), b.prototype.next = function(b) {
        ...
        xc = Ja.Observable = function() {
          ...
          function b(b) {
            if (Ja.config.longStackSupport && Ua) {
              var c = Ta(d)(new Error).e;
              this.stack = c.stack.substring(c.stack.indexOf("\n") + 1), this._subscribe = a(this, b);
            } else
              this._subscribe = b;
          }
          return rc = b.prototype, b.isObservable = function(a) {
            return a && Ra(a.subscribe);
          }, rc.subscribe = rc.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : qc(a, b, c));
          }, rc.subscribeOnNext = function(a, b) {
            return this._subscribe(qc("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, rc.subscribeOnError = function(a, b) {
            return this._subscribe(qc(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, rc.subscribeOnCompleted = function(a, b) {
            return this._subscribe(qc(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, b;
        }(),
        yc = Ja.ObservableBase = function(a) {
          function b(a) {
            return a && Ra(a.dispose) ? a : Ra(a) ? Sb(a) : Tb;
          }
          function c(a, c) {
            var e = c[0],
                f = c[1],
                g = Ta(f.subscribeCore).call(f, e);
            return g !== Sa || e.fail(Sa.e) ? void e.setDisposable(b(g)) : d(Sa.e);
          }
          function e(a) {
            var b = new Yd(a),
                d = [b, this];
            return fc.scheduleRequired() ? fc.scheduleWithState(d, c) : c(null, d), b;
          }
          function f() {
            a.call(this, e);
          }
          return Kb(f, a), f.prototype.subscribeCore = cb, f;
        }(xc),
        zc = function(a) {
          function b(b, c, d, e) {
          ...
          return Kb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = this.i++,
                  c = Ta(this.selector)(a, b, this.source);
              if (c === Sa)
        ...
        Ac = Ja.internals.Enumerable = function() {},
        Bc = function(a) {
          function b(b) {
          ...
          return Kb(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                d = new Xb,
                e = ec.scheduleRecursiveWithState(this.sources[eb](), function(e, f) {
                  if (!b) {
                    var g = Ta(e.next).call(e);
                    if (g === Sa)
    ...
    var Cc = function(a) {
      ...
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[eb](),
            d = new Xb,
            e = ec.scheduleRecursiveWithState(null, function(e, f) {
              if (!b) {
                var g = Ta(c.next).call(c);
                if (g === Sa)
                  return a.onError(g.e);
                if (g.done)
    ...
    Ac.prototype.catchError = function() {
      return new Cc(this);
    }, Ac.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new Xd(function(c) {
        var d,
            e,
            ...
            j = b[eb](),
            k = new Xb,
            l = ec.scheduleRecursive(function(a) {
              if (!d) {
                var b = Ta(j.next).call(j);
                if (b === Sa)
                ...
                var i = new Wb,
                    l = new Wb;
                k.setDisposable(new Pb(l, i)), i.setDisposable(h.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
        ...
        return new Pb(i, k, l, Sb(function() {
          d = !0;
        }));
      });
    };
    var Dc = function(a) {
      ...
      return Kb(b, a), b.prototype[eb] = function() {
        return new c(this);
        ...
        Gc = Ac.of = function(a, b, c) {
          return new Fc(a, b, c);
        };
    rc.observeOn = function(a) {
      var b = this;
      return new Xd(function(c) {
        return b.subscribe(new wc(a, c));
      }, b);
    }, rc.subscribeOn = function(a) {
      var b = this;
      return new Xd(function(c) {
        var d = new Wb,
            e = new Xb;
    ...
    var Hc = function(a) {
      ...
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Ic = xc.fromPromise = function(a) {
          return new Hc(a);
        };
    rc.toPromise = function(a) {
      if (a || (a = Ja.config.Promise), !a)
        throw new ab("Promise type not provided nor in Rx.config.Promise");
      var b = this;
    ...
    var Kc = xc.defer = function(a) {
      return new Xd(function(b) {
        var c;
        try {
          c = a();
        } catch (d) {
          return bd(d).subscribe(b);
        }
        return Qa(c) && (c = Ic(c)), c.subscribe(b);
      });
    },
        Lc = function(a) {
          function b(b) {
        ...
        Mc = new Lc(ec),
        Nc = xc.empty = function(a) {
          return ac(a) || (a = ec), a === ec ? Mc : new Lc(a);
        },
        Oc = function(a) {
          function b(b, c, d) {
        ...
        Pc = function() {
          ...
          return a.prototype.run = function() {
            function a(a, b) {
              var f = Ta(c.next).call(c);
              if (f === Sa)
                return d.onError(f.e);
              if (f.done)
                return d.onCompleted();
              var g = f.value;
              return Ra(e) && (g = Ta(e)(g, a), g === Sa) ? d.onError(g.e) : (d.onNext(g), void b(a + 1));
            }
    ...
    var Rc = xc.from = function(a, b, c, d) {
      if (null == a)
    ...
    var Tc = xc.fromArray = function(a, b) {
      return ac(b) || (b = fc), new Sc(a, b);
    };
    xc.generate = function(a, b, c, d, e) {
      return ac(e) || (e = fc), new Xd(function(f) {
        var g = !0;
    ...
    var _c = function(a) {
      ...
      function d(a, b) {
        var c = b[0],
            d = b[1];
        return d.onNext(c), d.onCompleted(), Tb;
      }
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return this.scheduler === ec ? d(null, a) : this.scheduler.scheduleWithState(a, d);
      }, b;
    }(yc),
        ad = (xc["return"] = xc.just = function(a, b) {
          return ac(b) || (b = ec), new _c(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        bd = xc["throw"] = function(a, b) {
          return ac(b) || (b = ec), new ad(a, b);
        };
    xc.using = function(a, b) {
      return new Xd(function(c) {
        var d = Tb,
            e = Ta(a)();
        if (e === Sa)
          return new Pb(bd(e.e).subscribe(c), d);
        e && (d = e);
        var f = Ta(b)(e);
        return f === Sa ? new Pb(bd(f.e).subscribe(c), d) : new Pb(f.subscribe(c), d);
      });
    }, rc.amb = function(a) {
      var b = this;
      return new Xd(function(c) {
        ...
        return i.setDisposable(b.subscribe(k)), j.setDisposable(a.subscribe(l)), new Pb(i, j);
      });
    }, xc.amb = function() {
      var a,
          b = Wc();
    ...
    rc["catch"] = function(a) {
      return Ra(a) ? G(this, a) : dd([this, a]);
    };
    var dd = xc["catch"] = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
    ...
    var ed = xc.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = Ra(b[a - 1]) ? b.pop() : I;
      return Array.isArray(b[0]) && (b = b[0]), new Xd(function(a) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new Wb;
            Qa(f) && (f = Ic(f)), g.setDisposable(f.subscribe(function(a) {
              j[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    rc.concat = function() {
      for (var a = [],
        ...
        a.push(arguments[b]);
      return a.unshift(this), gd.apply(null, a);
    };
    var fd = function(a) {
      function b(b) {
        this.sources = b, a.call(this);
      ...
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = ec.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
        ...
        return new Pb(b, f, Sb(function() {
          a = !0;
        }));
      }, b;
    }(yc),
        gd = xc.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
    ...
    var hd = function(a) {
      ...
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new Pb;
        return b.add(this.source.subscribe(new id(a, this.maxConcurrent, b))), b;
      }, b;
    }(yc),
        id = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new Wb;
            this.g.add(c), Qa(a) && (a = Ic(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    rc.merge = function(a) {
      return "number" != typeof a ? jd(this, a) : new hd(this, a);
    };
    var jd = xc.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      ...
      return Array.isArray(c[0]) && (c = c[0]), C(a, c).mergeAll();
        ...
        kd = function(a) {
          ...
          return Kb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = new Wb;
              this.g.add(b), Qa(a) && (a = Ic(a)), b.setDisposable(a.subscribe(new d(this, b)));
            }
          }, c.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, c.prototype.onCompleted = function() {
    ...
    var ld = Ja.CompositeError = function(a) {
    ...
    ld.prototype = Error.prototype, xc.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new Xd(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : 1 === g.length ? a.onError(g[0]) : a.onError(new ld(g));
        }
        var c = new Pb,
            e = new Wb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new Wb;
          c.add(e), Qa(d) && (d = Ic(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    }, rc.onErrorResumeNext = function(a) {
      if (!a)
        throw new Error("Second observable is required");
      return md([this, a]);
    };
    var md = xc.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new Xd(function(b) {
        var c = 0,
            d = new Xb,
            e = ec.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], Qa(f) && (f = Ic(f)), g = new Wb, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new Pb(d, e);
      });
    };
    rc.skipUntil = function(a) {
      ...
      return new Xd(function(c) {
        var d = !1,
            e = new Pb(b.subscribe(function(a) {
              d && c.onNext(a);
            }, function(a) {
              c.onError(a);
            }, function() {
    ...
    var nd = function(a) {
      ...
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new Wb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), Qa(a) && (a = Ic(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    var od = function(a) {
      function b(b, c) {
        this.source = b, this.other = Qa(c) ? Ic(c) : c, a.call(this);
      }
      function c(a) {
        this.o = a, this.isStopped = !1;
      }
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        return new Pb(this.source.subscribe(a), this.other.subscribe(new c(a)));
      }, c.prototype.onNext = function(a) {
    ...
    rc.takeUntil = function(a) {
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Xd(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new Wb;
            Qa(d) && (d = Ic(d)), e.setDisposable(d.subscribe(function(a) {
        ...
        return k.setDisposable(e.subscribe(function(b) {
          var c = [b].concat(h);
          if (g) {
            var e = Ta(d).apply(null, c);
            return e === Sa ? a.onError(e.e) : void a.onNext(e);
          }
        }, function(b) {
          a.onError(b);
        }, function() {
      ...
      var e = this;
      return b.unshift(e), new Xd(function(a) {
        for (var c = b.length,
            f = p(c, J),
            g = p(c, H),
            h = new Array(c),
          ...
          !function(c) {
            var i = b[c],
                j = new Wb;
            Qa(i) && (i = Ic(i)), j.setDisposable(i.subscribe(function(b) {
      ...
      return b.unshift(e), new Xd(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var i = b[c],
                j = new Wb;
            (hb(i) || gb(i)) && (i = Rc(i)), j.setDisposable(i.subscribe(function(b) {
              if (f[c].push(b), f.every(function(a) {
                return a.length > 0;
              })) {
                var h = f.map(function(a) {
      ...
      return new Xd(K(this), this);
    }, rc.bufferWithCount = function(a, b) {
    ...
    var pd = function(a) {
      ...
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new qd(a, this.keyFn, this.comparer));
      }, b;
    }(yc),
        qd = function(a) {
          function b(b, c, d) {
          ...
          return Kb(b, a), b.prototype.next = function(a) {
            var b,
                c = a;
            return Ra(this.keyFn) && (c = Ta(this.keyFn)(a), c === Sa) ? this.o.onError(c.e) : this.hasCurrentKey && (b = Ta(this.comparer)(this.currentKey, c), b === Sa) ? this.o.onError(b.e) : void(this.hasCurrentKey && b || (this.hasCurrentKey = !0, this.currentKey = c, this.o.onNext(a)));
          }, b.prototype.error = function(a) {
            this.o.onError(a);
          }, b.prototype.completed = function() {
            this.o.onCompleted();
    ...
    var rd = function(a) {
      ...
      function c(a, b) {
        this.o = a, this.t = !b._oN || Ra(b._oN) ? qc(b._oN || Ka, b._oE || Ka, b._oC || Ka) : b._oN, this.isStopped = !1;
      }
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new c(a, this));
      }, c.prototype.onNext = function(a) {
        if (!this.isStopped) {
          var b = Ta(this.t.onNext).call(this.t, a);
          b === Sa && this.o.onError(b.e), this.o.onNext(a);
        }
      }, c.prototype.onError = function(a) {
        if (!this.isStopped) {
          this.isStopped = !0;
          var b = Ta(this.t.onError).call(this.t, a);
          if (b === Sa)
        ...
        if (!this.isStopped) {
          this.isStopped = !0;
          var a = Ta(this.t.onCompleted).call(this.t);
          if (a === Sa)
    ...
    rc["do"] = rc.tap = rc.doAction = function(a, b, c) {
      return new rd(this, a, b, c);
    ...
    }, rc["finally"] = function(a) {
      var b = this;
      return new Xd(function(c) {
        var e = Ta(b.subscribe).call(b, c);
        return e === Sa ? (a(), d(e.e)) : Sb(function() {
          var b = Ta(e.dispose).call(e);
          a(), b === Sa && d(b.e);
        });
      }, this);
    };
    ...
    rc.ignoreElements = function() {
      ...
      return Ec(this, a).concat();
    }, rc.retry = function(a) {
      return Ec(this, a).catchError();
    }, rc.retryWhen = function(a) {
      return Ec(this).catchErrorWhen(a);
    };
    var td = function(a) {
      function b(b, c, d, e) {
    ...
    N.prototype = {
      ...
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new td(this, c, b, a);
      ...
      var a,
          b = 0;
      arguments.length && ac(arguments[0]) ? (a = arguments[0], b = 1) : a = ec;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Gc([Tc(c, a), this]).concat();
    ...
    }, rc.windowWithCount = function(a, b) {
      var c = this;
      ...
      return Ra(a) && Ra(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return Qa(e) && (e = Ic(e)), (hb(e) || gb(e)) && (e = Rc(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }) : Ra(a) ? O(this, a, c) : O(this, function() {
        return a;
      });
    }, rc.concatMapObserver = rc.selectConcatObserver = function(a, b, c, d) {
      var e = this,
          f = jb(a, d, 2),
          g = jb(b, d, 1),
          h = jb(c, d, 0);
      return new Xd(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          Qa(c) && (c = Ic(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          Qa(b) && (b = Ic(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, rc.defaultIfEmpty = function(b) {
      var c = this;
    ...
    }, rc.groupBy = function(a, b) {
      return this.groupByUntil(a, b, Wc);
    }, rc.groupByUntil = function(b, c, d) {
      var e = this;
      return new Xd(function(f) {
        var g = new Td,
            h = new Pb,
        ...
        return h.add(e.subscribe(function(e) {
          ...
          var l = !1,
              m = g.get(k);
          if (m === a && (m = new $d, g.set(k, m), l = !0), l) {
            var n = new Zd(k, m, i),
                o = new Zd(k, m),
                p = Ta(d)(o);
            if (p === Sa)
            ...
            f.onNext(n);
            var q = new Wb;
            h.add(q), q.setDisposable(p.take(1).subscribe(Ka, function(a) {
          ...
          var r = e;
          return Ra(c) && (r = Ta(c)(e), r === Sa) ? (g.forEach(j(r.e)), f.onError(r.e)) : void m.onNext(r);
        }, function(a) {
          g.forEach(j(a)), f.onError(a);
        }, function() {
    ...
    var ud = function(a) {
      ...
      return Kb(b, a), b.prototype.internalMap = function(a, d) {
        ...
        if (!this.isStopped) {
          var b = Ta(this.selector)(a, this.i++, this.source);
    ...
    rc.map = rc.select = function(a, b) {
      var c = "function" == typeof a ? a : function() {
        return a;
      };
      return this instanceof ud ? this.internalMap(c, b) : new ud(this, c, b);
    }, rc.pluck = function() {
    ...
    }, rc.flatMap = rc.selectMany = function(a, b, c) {
      return new zc(this, a, b, c).mergeAll();
    }, rc.flatMapObserver = rc.selectManyObserver = function(a, b, c, d) {
      var e = this;
      return new Xd(function(f) {
        var g = 0;
        return e.subscribe(function(b) {
          ...
          Qa(c) && (c = Ic(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          Qa(a) && (a = Ic(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    }, Ja.Observable.prototype.flatMapLatest = function(a, b, c) {
      return new zc(this, a, b, c).switchLatest();
    };
    var vd = function(a) {
      function b(b, c) {
    ...
    var wd = function(a) {
      ...
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = Ta(this.predicate)(a, this.i++, this.source);
    ...
    rc.filter = rc.where = function(a, b) {
      return this instanceof wd ? this.internalFilter(a, b) : new wd(this, a, b);
    };
    var xd = function(a) {
      function b(b, c, d, e) {
      ...
      return Kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        this.isStopped || (!this.hasValue && (this.hasValue = !0), this.hasAccumulation ? this.result = Ta(this.acc)(this.result, a) : (this.result = this.hasSeed ? Ta(this.acc)(this.seed, a) : a, this.hasAccumulation = !0), this.result === Sa && this.o.onError(this.result.e));
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
        this.isStopped || (this.isStopped = !0, this.hasValue && this.o.onNext(this.result), !this.hasValue && this.hasSeed && this.o.onNext(this.seed), !this.hasValue && !this.hasSeed && this.o.onError(new Za), this.o.onCompleted());
      }, c.prototype.dispose = function() {
        this.isStopped = !0;
      }, c.prototype.fail = function(a) {
        return this.isStopped ? !1 : (this.isStopped = !0, this.o.onError(a), !0);
    ...
    var yd = function(a) {
      ...
      return Kb(b, a), b.prototype.next = function(a) {
        var b = Ta(this._fn)(a, this._i++, this._s);
    ...
    rc.some = function(a, b) {
      var c = this,
          d = jb(a, b, 3);
      return new Xd(function(a) {
        return c.subscribe(new yd(a, d, c));
      });
    };
    var zd = function(a) {
      function b(b) {
      ...
      return Kb(b, a), b.prototype.next = function() {
        this._o.onNext(!1), this._o.onCompleted();
      }, b.prototype.error = function(a) {
        this._o.onError(a);
      }, b.prototype.completed = function() {
    ...
    rc.every = function(a, b) {
      var c = this,
          d = jb(a, b, 3);
      return new Xd(function(a) {
        return c.subscribe(new Ad(a, d, c));
      }, this);
    }, rc.includes = function(a, b) {
      function c(a, b) {
      ...
      return new Xd(function(e) {
        var f = 0,
            g = +b || 0;
        return Math.abs(g) === 1 / 0 && (g = 0), 0 > g ? (e.onNext(!1), e.onCompleted(), Tb) : d.subscribe(function(b) {
    ...
    }, rc.contains = function(a, b) {
      rc.includes(a, b);
    }, rc.count = function(a, b) {
      return a ? this.filter(a, b).count() : this.reduce(function(a) {
        return a + 1;
      }, 0);
    }, rc.indexOf = function(a, b) {
      var c = this;
      return new Xd(function(d) {
        var e = 0,
            f = +b || 0;
        return Math.abs(f) === 1 / 0 && (f = 0), 0 > f ? (d.onNext(-1), d.onCompleted(), Tb) : c.subscribe(function(b) {
    ...
    var Bd = function(a) {
      ...
      return Kb(b, a), b.prototype.next = function(a) {
        if (this._fn) {
          var b = Ta(this._fn)(a, this._c++, this._s);
          if (b === Sa)
            return this._o.onError(b.e);
          this._t += b;
        } else
        ...
        return 0 === this._c ? this._o.onError(new Za) : (this._o.onNext(this._t / this._c), void this._o.onCompleted());
      }, b;
    }(sc);
    rc.average = function(a, b) {
      var c,
          d = this;
      return Ra(a) && (c = jb(a, b, 3)), new Xd(function(a) {
        return d.subscribe(new Bd(a, c, d));
      }, d);
    }, rc.sequenceEqual = function(a, b) {
      var c = this;
      return b || (b = Na), new Xd(function(d) {
        var e = !1,
            f = !1,
      ...
      return new Xd(function(e) {
        ...
        return d.subscribe(function(a) {
          ...
          c === a ? e.onError(new _a) : (e.onNext(c), e.onCompleted());
        });
      }, d);
    }, rc.single = function(a, b) {
      if (Ra(a))
    ...
    var Cd = function(b) {
      ...
      return Kb(c, b), c.prototype.next = function(a) {
        if (this._obj.predicate) {
          var b = Ta(this._obj.predicate)(a, this._i++, this._s);
          if (b === Sa)
            return this._o.onError(b.e);
        ...
        this._obj.defaultValue === a ? this._o.onError(new Za) : (this._o.onNext(this._obj.defaultValue), this._o.onCompleted());
      }, c;
    }(sc);
    rc.first = function() {
      var a = {},
      ...
      if (a = "object" == typeof arguments[0] ? arguments[0] : {
        ...
        var c = a.predicate;
        a.predicate = jb(c, a.thisArg, 3);
      }
      return new Xd(function(c) {
        return b.subscribe(new Cd(c, a, b));
      }, b);
    }, rc.last = function() {
      var b = {},
          c = this;
      ...
      return new Xd(function(d) {
        ...
        return c.subscribe(function(a) {
          ...
          f ? (d.onNext(e), d.onCompleted()) : b.defaultValue === a ? d.onError(new Za) : (d.onNext(b.defaultValue), d.onCompleted());
        });
      }, c);
    }, rc.find = function(a, b) {
      return U(this, a, b, !1);
    }, rc.findIndex = function(a, b) {
      return U(this, a, b, !0);
    }, rc.toSet = function() {
      ...
      function b() {
        return xc.spawn.call(this, a.apply(this, arguments));
      }
      return b.__generatorFunction__ = a, b;
    };
    var Dd = xc.spawn = function() {
      ...
      return new Xd(function(d) {
        function e(b) {
          var c = Ta(a.next).call(a, b);
          return c === Sa ? d.onError(c.e) : void g(c);
        }
        function f(b) {
          var c = Ta(a.next).call(a, b);
          return c === Sa ? d.onError(c.e) : void g(c);
        ...
        function g(a) {
          ...
          xc.isObservable(c) ? h.add(c.subscribe(e, f)) : f(new TypeError("type not supported"));
        }
        var h = new Pb;
        return Ra(a) && (a = a.apply(b, c)), a && Ra(a.next) ? (e(), h) : (d.onNext(a), d.onCompleted());
      });
    };
    xc.start = function(a, b, c) {
      return Ed(a, b, c)();
    };
    var Ed = xc.toAsync = function(a, b, c) {
      return ac(c) || (c = jc), function() {
        var d = arguments,
            e = new _d;
    ...
    }, Ja.config.useNativeEvents = !1, xc.fromEvent = function(a, b, c) {
      return a.addListener ? Fd(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : Ja.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new Xd(function(d) {
        return ea(a, b, fa(d, c));
    ...
    var Fd = xc.fromEventPattern = function(a, b, c, d) {
      return ac(d) || (d = ec), new Xd(function(d) {
        function e() {
          var a = arguments[0];
          return Ra(c) && (a = Ta(c).apply(null, arguments), a === Sa) ? d.onError(a.e) : void d.onNext(a);
        }
        var f = a(e);
        return Sb(function() {
          Ra(b) && b(e, f);
    ...
    var Hd = function(b) {
      function c(b) {
        ...
        var d,
            e = [],
            f = ga(this.source, this.pauser.startWith(!1).distinctUntilChanged(), function(a, b) {
              return {
                data: a,
                shouldFire: b
              };
    ...
    var Id = function(a) {
      ...
      return Kb(c, a), c.prototype.request = function(a) {
        ...
        Jd = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new $d, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = null, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || fc;
          }
          return Kb(c, a), Lb(c.prototype, pc, {
            onCompleted: function() {
              this.hasCompleted = !0, this.enableQueue && 0 !== this.queue.length ? this.queue.push(lc.createOnCompleted()) : (this.subject.onCompleted(), this.disposeCurrentRequest());
            },
            onError: function(a) {
              this.hasFailed = !0, this.error = a, this.enableQueue && 0 !== this.queue.length ? this.queue.push(lc.createOnError(a)) : (this.subject.onError(a), this.disposeCurrentRequest());
            },
            onNext: function(a) {
              this.requestedCount <= 0 ? this.enableQueue && this.queue.push(lc.createOnNext(a)) : (0 === this.requestedCount-- && this.disposeCurrentRequest(), this.subject.onNext(a));
            },
            ...
            request: function(a) {
              ...
              return this.requestedDisposable = this.scheduler.scheduleWithState(a, function(a, c) {
                ...
                return !e && d > 0 ? (b.requestedCount = d, Sb(function() {
                  b.requestedCount = 0;
                })) : void 0;
    ...
    rc.controlled = function(a, b) {
      return a && ac(a) && (b = a, a = !0), null == a && (a = !0), new Id(this, a, b);
    };
    var Kd = function(a) {
      function b(a) {
        this.subscription = this.source.subscribe(new d(a, this, this.subscription));
        var b = this;
        return jc.schedule(function() {
          b.source.request(1);
        }), this.subscription;
      }
      function c(c) {
    ...
    Id.prototype.windowed = function(a) {
      ...
      return "function" == typeof a ? new Xd(function(d) {
        var e = c.multicast(a());
        return new Pb(b(e).subscribe(d), e.connect());
      }, c) : new Pd(c, a);
    ...
    var Nd = Ja.BehaviorSubject = function(a) {
      function c(a) {
        return Vb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), Tb) : (this.observers.push(a), a.onNext(this.value), new Md(this, a));
      }
      function d(b) {
        a.call(this, c), this.value = b, this.observers = [], this.isDisposed = !1, this.isStopped = !1, this.hasError = !1;
      }
      return Kb(d, a), Lb(d.prototype, pc, {
        getValue: function() {
          if (Vb(this), this.hasError)
            throw this.error;
          return this.value;
        },
        ...
        Od = Ja.ReplaySubject = function(a) {
          function c(a, b) {
            return Sb(function() {
          ...
          function d(a) {
            var b = new vc(this.scheduler, a),
                d = c(this, b);
            Vb(this), this._trim(this.scheduler.now()), this.observers.push(b);
            for (var e = 0,
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || fc, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
          var f = Math.pow(2, 53) - 1;
          return Kb(e, a), Lb(e.prototype, pc.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
        ...
        Pd = Ja.ConnectableObservable = function(a) {
          function b(b, c) {
            var d,
                e = !1,
                f = b.asObservable();
            this.connect = function() {
              return e || (e = !0, d = new Pb(f.subscribe(c), Sb(function() {
                e = !1;
              }))), d;
    ...
    rc.singleInstance = function() {
      ...
      return new Xd(function(f) {
        ...
        return g.add(e.subscribe(function(a) {
          ...
          l.set(c, a), g.add(e);
          var i = Ta(b)(a);
          return i === Sa ? f.onError(i.e) : (e.setDisposable(i.take(1).subscribe(Ka, n, function() {
            l["delete"](c) && 0 === l.size && h && f.onCompleted(), g.remove(e);
          })), void m.forEach(function(b) {
            var c = Ta(d)(a, b);
            return c === Sa ? f.onError(c.e) : void f.onNext(c);
          }));
        }, n, function() {
          ...
          m.set(b, a), g.add(e);
          var h = Ta(c)(a);
          return h === Sa ? f.onError(h.e) : (e.setDisposable(h.take(1).subscribe(Ka, n, function() {
      ...
      return new Xd(function(f) {
        ...
        return h.add(e.subscribe(function(a) {
          ...
          h.add(n);
          var o = Ta(b)(a);
          return o === Sa ? (j.forEach(g(o.e)), f.onError(o.e)) : void n.setDisposable(o.take(1).subscribe(Ka, function(a) {
          ...
          h.add(d);
          var e = Ta(c)(a);
          return e === Sa ? (j.forEach(g(e.e)), f.onError(e.e)) : (d.setDisposable(e.take(1).subscribe(Ka, function(a) {
            j.forEach(g(a)), f.onError(a);
          }, function() {
    ...
    rc.letBind = rc.let = function(a) {
      return a(this);
    }, xc["if"] = function(a, b, c) {
      return Kc(function() {
        return c || (c = Nc()), Qa(b) && (b = Ic(b)), Qa(c) && (c = Ic(c)), "function" == typeof c.now && (c = Nc(c)), a() ? b : c;
      });
    }, xc["for"] = xc.forIn = function(a, b, c) {
      return Gc(a, b, c).concat();
    };
    var Rd = xc["while"] = xc.whileDo = function(a, b) {
      return Qa(b) && (b = Ic(b)), ka(a, b).concat();
    };
    rc.doWhile = function(a) {
      return gd([this, Rd(a, this)]);
    }, xc["case"] = function(a, b, c) {
      return Kc(function() {
        Qa(c) && (c = Ic(c)), c || (c = Nc()), ac(c) && (c = Nc(c));
        var d = b[a()];
        return Qa(d) && (d = Ic(d)), d || c;
      });
    }, rc.expand = function(a, b) {
      ac(b) || (b = ec);
      var c = this;
      return new Xd(function(d) {
        var e = [],
      ...
      return new Xd(function(b) {
        ...
        for (var d = new Pb,
          ...
          !function(i) {
            var j = a[i];
            Qa(j) && (j = Ic(j)), d.add(j.subscribe(function(a) {
              e || (f[i] = !0, h[i] = a);
            }, function(a) {
      ...
      return new Xd(function(d) {
        var e,
            ...
            k = new Wb,
            l = new Wb;
        return Qa(a) && (a = Ic(a)), k.setDisposable(c.subscribe(function(a) {
          i = !0, e = a;
        }, function(a) {
    ...
    }, rc.manySelect = rc.extend = function(a, b) {
      ac(b) || (b = ec);
      var c = this;
      return Kc(function() {
        var d;
    ...
    var Sd = function(a) {
      function b(a) {
        var b = this,
            c = new Pb;
        return c.add(fc.schedule(function() {
      ...
      return Kb(c, a), Lb(c.prototype, pc, {
        onCompleted: function() {
          this.onNext(xc.empty());
        },
        onError: function(a) {
          this.onNext(xc["throw"](a));
        },
        onNext: function(a) {
    ...
    var Vd = xc.interval = function(a, b) {
      return sa(a, a, ac(b) ? b : jc);
    };
    xc.timer = function(b, c, d) {
      var e;
      return ac(d) || (d = jc), null != c && "number" == typeof c ? e = c : ac(c) && (d = c), b instanceof Date && e === a ? pa(b.getTime(), d) : b instanceof Date && e !== a ? qa(b.getTime(), c, d) : e === a ? ra(b, d) : sa(b, e, d);
    };
    rc.delay = function() {
      if ("number" == typeof arguments[0] || arguments[0] instanceof Date) {
        var a = arguments[0],
            b = arguments[1];
        return ac(b) || (b = jc), a instanceof Date ? ua(this, a, b) : ta(this, a, b);
      }
      if (Ra(arguments[0]))
        return va(this, arguments[0], arguments[1]);
      throw new Error("Invalid arguments");
    }, rc.debounce = function() {
      if (Ra(arguments[0]))
        return xa(this, arguments[0]);
      if ("number" == typeof arguments[0])
        return wa(this, arguments[0], arguments[1]);
      throw new Error("Invalid arguments");
    }, rc.windowWithTime = function(a, b, c) {
      var d,
          e = this;
      return null == b && (d = a), ac(c) || (c = jc), "number" == typeof b ? d = b : ac(b) && (d = a, c = b), new Xd(function(b) {
        function f() {
          var a = new Wb,
              e = !1,
              g = !1;
        ...
        var g,
            ...
            l = new Xb,
            m = 0;
        return g = new Pb(l), h = new Yb(g), k.push(new $d), b.onNext(Mb(k[0], h)), f(), g.add(e.subscribe(function(a) {
          for (var b = 0,
              c = k.length; c > b; b++)
            k[b].onNext(a);
        }, function(a) {
    ...
    }, rc.windowWithTimeOrCount = function(a, b, c) {
      var d = this;
      return ac(c) || (c = jc), new Xd(function(e) {
        function f(b) {
          var d = new Wb;
          g.setDisposable(d), d.setDisposable(c.scheduleWithRelative(a, function() {
            if (b === k) {
              j = 0;
              var a = ++k;
              l.onCompleted(), l = new $d, e.onNext(Mb(l, i)), f(a);
            }
          }));
        }
        var g = new Xb,
            ...
            k = 0,
            l = new $d;
        return e.onNext(Mb(l, i)), f(0), h.add(d.subscribe(function(a) {
          var c = 0,
              d = !1;
          l.onNext(a), ++j === b && (d = !0, j = 0, c = ++k, l.onCompleted(), l = new $d, e.onNext(Mb(l, i))), d && f(c);
        }, function(a) {
    ...
    }, rc.bufferWithTime = function(a, b, c) {
      return this.windowWithTime(a, b, c).flatMap(L);
    }, rc.bufferWithTimeOrCount = function(a, b, c) {
      return this.windowWithTimeOrCount(a, b, c).flatMap(L);
    }, rc.timeInterval = function(a) {
      var b = this;
      return ac(a) || (a = jc), Kc(function() {
        var c = a.now();
      ...
      return ac(a) || (a = jc), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      ...
      return ac(b) || (b = jc), "number" == typeof a ? ya(this, Vd(a, b)) : ya(this, a);
    };
    var Wd = Ja.TimeoutError = function(a) {
      this.message = a || "Timeout has occurred", this.name = "TimeoutError", Error.call(this);
    };
    Wd.prototype = Object.create(Error.prototype), rc.timeout = function() {
      var a = arguments[0];
      if (a instanceof Date || "number" == typeof a)
        return Aa(this, a, arguments[1], arguments[2]);
      if (xc.isObservable(a) || Ra(a))
        return za(this, a, arguments[1], arguments[2]);
      throw new Error("Invalid arguments");
    }, xc.generateWithAbsoluteTime = function(a, b, c, d, e, f) {
      return ac(f) || (f = jc), new Xd(function(g) {
        var h = !0,
            i = !1;
    ...
    }, xc.generateWithRelativeTime = function(a, b, c, d, e, f) {
      return ac(f) || (f = jc), new Xd(function(g) {
        var h = !0,
            i = !1;
    ...
    }, rc.takeLastWithTime = function(a, b) {
      var c = this;
      return ac(b) || (b = jc), new Xd(function(d) {
        var e = [];
        return c.subscribe(function(c) {
          var d = b.now();
          for (e.push({
    ...
    }, rc.takeLastBufferWithTime = function(a, b) {
      var c = this;
      return ac(b) || (b = jc), new Xd(function(d) {
        var e = [];
        return c.subscribe(function(c) {
    ...
    }, rc.takeWithTime = function(a, b) {
      var c = this;
      return ac(b) || (b = jc), new Xd(function(d) {
        return new Pb(b.scheduleWithRelative(a, function() {
          d.onCompleted();
        }), c.subscribe(d));
      }, c);
    }, rc.skipWithTime = function(a, b) {
      var c = this;
      return ac(b) || (b = jc), new Xd(function(d) {
        var e = !1;
        return new Pb(b.scheduleWithRelative(a, function() {
    ...
    }, rc.skipUntilWithTime = function(a, b) {
      ac(b) || (b = jc);
      var c = this,
          d = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new Xd(function(e) {
        var f = !1;
        return new Pb(b[d](a, function() {
          f = !0;
        }), c.subscribe(function(a) {
          f && e.onNext(a);
        }, function(a) {
    ...
    }, rc.takeUntilWithTime = function(a, b) {
      ac(b) || (b = jc);
      var c = this,
          d = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new Xd(function(e) {
      ...
      return new Xd(function(d) {
        var e = a(b(d));
        return c.subscribe(function(a) {
          var b = Ta(e["@@transducer/step"]).call(e, d, a);
          b === Sa && d.onError(b.e);
        }, function(a) {
          d.onError(a);
        }, function() {
    ...
    }, rc.flatMapFirst = rc.selectManyFirst = function(a, b, c) {
      return new zc(this, a, b, c).switchFirst();
    }, Ja.Observable.prototype.flatMapWithMaxConcurrent = function(a, b, c, d) {
      return new zc(this, b, c, d).merge(a);
    };
    Ja.VirtualTimeScheduler = function(a) {
      ...
      function g(f, g) {
        this.clock = f, this.comparer = g, this.isEnabled = !1, this.queue = new Nb(1024), a.call(this, b, c, d, e);
      }
      Kb(g, a);
      var h = g.prototype;
      return h.add = cb, h.toDateTimeOffset = cb, h.toRelative = cb, h.schedulePeriodicWithState = function(a, b, c) {
        var d = new dc(this, a, b, c);
        return d.start();
        ...
        var e = this,
            f = new Zb(this, a, d, b, this.comparer);
    ...
    var Xd = Ja.AnonymousObservable = function(a) {
      ...
      return Kb(f, a), f;
        ...
        Yd = function(a) {
          ...
          var c = b.prototype;
          return c.next = function(a) {
            var b = Ta(this.observer.onNext).call(this.observer, a);
            b === Sa && (this.dispose(), d(b.e));
          }, c.error = function(a) {
            var b = Ta(this.observer.onError).call(this.observer, a);
            this.dispose(), b === Sa && d(b.e);
          }, c.completed = function() {
            var a = Ta(this.observer.onCompleted).call(this.observer);
            this.dispose(), a === Sa && d(a.e);
        ...
        Zd = function(a) {
          ...
          function c(c, d, e) {
            a.call(this, b), this.key = c, this.underlyingObservable = e ? new Xd(function(a) {
              return new Pb(e.getDisposable(), d.subscribe(a));
            }) : d;
          }
          return Kb(c, a), c;
        }(xc),
        $d = Ja.Subject = function(a) {
          function c(a) {
            return Vb(this), this.isStopped ? this.hasError ? (a.onError(this.error), Tb) : (a.onCompleted(), Tb) : (this.observers.push(a), new Md(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
          }
          return Kb(d, a), Lb(d.prototype, pc.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            onCompleted: function() {
        ...
        _d = Ja.AsyncSubject = function(a) {
          function c(a) {
            return Vb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), Tb) : (this.observers.push(a), new Md(this, a));
          }
          function d() {
          ...
          return Kb(d, a), Lb(d.prototype, pc, {
            hasObservers: function() {
              return Vb(this), this.observers.length > 0;
            },
            onCompleted: function() {
              var a,
                  c;
            ...
            onNext: function(a) {
              Vb(this), this.isStopped || (this.value = a, this.hasValue = !0);
            },
            dispose: function() {
        ...
        ae = Ja.AnonymousSubject = function(a) {
          ...
          return Kb(c, a), Lb(c.prototype, pc.prototype, {
            onCompleted: function() {
