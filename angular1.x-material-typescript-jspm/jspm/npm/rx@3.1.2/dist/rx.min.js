...
(function(process) {
  (function(a) {
    ...
    function z(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && w(b) ? (b = y(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > $b ? $b : b) : b;
    }
    function A(a, b) {
      this.observer = a, this.parent = b;
    }
    function B(a, b) {
      return nb(a) || (a = rb), new ac(b, a);
    }
    function C(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function F(a, b) {
      return new Hc(function(c) {
        var d = new hb,
            e = new ib;
        return e.setDisposable(d), d.setDisposable(a.subscribe(new mc(c, e, b))), e;
      }, a);
    }
    function G() {
      return !1;
    ...
    var Q = {
      ...
      object: !0
        ...
        _ = Y.helpers.defaultNow = Date.now,
    ...
    var Xa = Y.internals.isEqual = function(a, b) {
      return o(a, b, [], []);
        ...
        ab = Y.CompositeDisposable = function() {
          var a,
              b,
              c = [];
    ...
    var cb = Y.Disposable = function(a) {
    ...
    var db = cb.create = function(a) {
      return new cb(a);
        ...
        hb = Y.SingleAssignmentDisposable = function() {
          this.isDisposed = !1, this.current = null;
        };
    hb.prototype.getDisposable = function() {
      return this.current;
    }, hb.prototype.setDisposable = function(a) {
      if (this.current)
    ...
    var ib = Y.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var jb = Y.RefCountDisposable = function() {
      function a(a) {
    ...
    var kb = Y.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || ba, this.disposable = new hb;
    };
    ...
    !function(a) {
      ...
      function c(a, b, c) {
        function d(b, e) {
          function h(a, b) {
            return i ? g.remove(k) : j = !0, f(b, d), eb;
          }
          var i = !1,
              j = !1,
              k = a[c](b, e, h);
    ...
    var ob,
        pb,
        qb = (Y.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
          ...
          return new lb(_, a, sa, sa);
        }()),
        rb = lb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.shift();
          ...
          function b(b, e) {
            var f = new kb(this, b, e, this.now());
            if (c)
              c.push(f);
            else {
              c = [f];
    ...
    !function() {
      ...
      if (ea(i))
        ...
        X.addEventListener ? X.addEventListener("message", c, !1) : X.attachEvent ? X.attachEvent("onmessage", c) : X.onmessage = c, ob = function(a) {
          var b = e++;
        ...
        ob = "document" in X && "onreadystatechange" in X.document.createElement("script") ? function(b) {
          ...
          var c = e++;
          return f[c] = b, tb(function() {
            a(c);
          }, 0), c;
        };
    }();
    var vb = (lb.timeout = lb["default"] = function() {
      function a(a, b) {
        var c = this,
            d = new hb,
            e = ob(function() {
      ...
      return Za(e, a), e.prototype._clone = function(a) {
        ...
        wb = Y.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return nb(a) || (a = qb), new Hc(function(c) {
        ...
        xb = wb.createOnNext = function() {
          ...
          return function(d) {
            return new wb("N", d, null, a, b, c);
          };
        }(),
        yb = wb.createOnError = function() {
          function a(a, b) {
          ...
          return function(d) {
            return new wb("E", null, d, a, b, c);
          };
        }(),
        zb = wb.createOnCompleted = function() {
          function a(a, b, c) {
            return c();
          }
          function b(a) {
          ...
          return function() {
            return new wb("C", null, null, a, b, c);
          };
        }(),
        Ab = Y.Observer = function() {};
    Ab.prototype.toNotifier = function() {
      var a = this;
      return function(b) {
        return b.accept(a);
      };
    }, Ab.prototype.asObserver = function() {
      var a = this;
      return new Eb(function(b) {
        a.onNext(b);
      }, function(b) {
        a.onError(b);
      }, function() {
    ...
    }, Ab.prototype.checked = function() {
      return new Fb(this);
    };
    var Bb = Ab.create = function(a, b, c) {
      return a || (a = Z), b || (b = ca), c || (c = Z), new Eb(a, b, c);
    };
    Ab.fromNotifier = function(a, b) {
      var c = ya(a, b, 1);
      return new Eb(function(a) {
        return c(xb(a));
      }, function(a) {
        return c(yb(a));
      }, function() {
    ...
    }, Ab.prototype.notifyOn = function(a) {
      return new Hb(a, this);
    }, Ab.prototype.makeSafe = function(a) {
      return new AnonymousSafeObserver(this._onNext, this._onError, this._onCompleted, a);
    };
    var Cb,
        Db = Y.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
        ...
        Eb = Y.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Gb = Y.internals.ScheduledObserver = function(a) {
          function b(b, c) {
        ...
        Ib = Y.Observable = function() {
          ...
          return Cb = b.prototype, b.isObservable = function(a) {
            ...
            return this._subscribe("object" == typeof a ? a : Bb(a, b, c));
          }, Cb.subscribeOnNext = function(a, b) {
            return this._subscribe(Bb("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Cb.subscribeOnError = function(a, b) {
            return this._subscribe(Bb(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Cb.subscribeOnCompleted = function(a, b) {
            return this._subscribe(Bb(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, b;
        }(),
        Jb = Y.ObservableBase = function(a) {
          function b(a) {
            return a && ea(a.dispose) ? a : ea(a) ? db(a) : eb;
          }
          function c(a, c) {
            var e = c[0],
                f = c[1],
          ...
          function e(a) {
            var b = new Ic(a),
                d = [b, this];
            return rb.scheduleRequired() ? rb.scheduleWithState(d, c) : c(null, d), b;
          }
          function f() {
            a.call(this, e);
          }
        ...
        Lb = Y.internals.Enumerable = function() {},
        Mb = function(a) {
          function b(b) {
          ...
          return Za(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                d = new ib,
                e = qb.scheduleRecursiveWithState(this.sources[ta](), function(e, f) {
                  if (!b) {
    ...
    var Nb = function(a) {
      ...
      return Za(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[ta](),
            d = new ib,
            e = qb.scheduleRecursiveWithState(null, function(e, f) {
              if (!b) {
    ...
    Lb.prototype.catchError = function() {
      return new Nb(this);
    }, Lb.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new Hc(function(c) {
        var d,
            e,
            ...
            j = b[ta](),
            k = new ib,
            l = qb.scheduleRecursive(function(a) {
              if (!d) {
                ...
                var i = new hb,
                    l = new hb;
                k.setDisposable(new ab(l, i)), i.setDisposable(h.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
    ...
    var Ob = function(a) {
      ...
      return Za(b, a), b.prototype[ta] = function() {
        ...
        Rb = Lb.of = function(a, b, c) {
          return new Qb(a, b, c);
        };
    Cb.observeOn = function(a) {
      var b = this;
      return new Hc(function(c) {
        return b.subscribe(new Hb(a, c));
      }, b);
    }, Cb.subscribeOn = function(a) {
      var b = this;
      return new Hc(function(c) {
        var d = new hb,
            e = new ib;
    ...
    Cb.toArray = function() {
      return new Ub(this);
    }, Ib.create = function(a, b) {
      return new Hc(a, b);
    };
    var Vb = (Ib.defer = function(a) {
      return new Hc(function(b) {
        var c;
        try {
          c = a();
        } catch (d) {
          return lc(d).subscribe(b);
        }
        return da(c) && (c = Tb(c)), c.subscribe(b);
      });
    }, function(a) {
      function b(b) {
      ...
      return Za(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Wb = new Vb(qb),
        Xb = Ib.empty = function(a) {
          return nb(a) || (a = qb), a === qb ? Wb : new Vb(a);
        },
        Yb = function(a) {
          function b(b, c, d) {
    ...
    var _b = Ib.from = function(a, b, c, d) {
      if (null == a)
    ...
    var bc = Ib.fromArray = function(a, b) {
      return nb(b) || (b = rb), new ac(a, b);
    };
    Ib.generate = function(a, b, c, d, e) {
      return nb(e) || (e = rb), new Hc(function(f) {
        var g = !0;
    ...
    C.prototype.run = function() {
      ...
      var b = this.observer,
          ...
          e = d.length;
      return this.parent.scheduler.scheduleRecursiveWithState(0, a);
    }, Ib.pairs = function(a, b) {
      return b || (b = rb), new fc(a, b);
    };
    var gc = function(a) {
      function b(b, c, d) {
    ...
    Ib.range = function(a, b, c) {
      return nb(c) || (c = rb), new gc(a, b, c);
    };
    var ic = function(a) {
      function b(b, c, d) {
    ...
    }, Ib.repeat = function(a, b, c) {
      return nb(c) || (c = rb), new ic(a, b, c);
    };
    var jc = function(a) {
      function b(b, c) {
      ...
      return Za(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return this.scheduler === qb ? d(null, a) : this.scheduler.scheduleWithState(a, d);
      }, b;
    }(Jb),
        kc = (Ib["return"] = Ib.just = function(a, b) {
          return nb(b) || (b = qb), new jc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        lc = Ib["throw"] = function(a, b) {
          return nb(b) || (b = qb), new kc(a, b);
        };
    Ib.using = function(a, b) {
      return new Hc(function(c) {
        var d = eb,
            e = ga(a)();
        if (e === fa)
          return new ab(lc(e.e).subscribe(c), d);
        e && (d = e);
        var f = ga(b)(e);
        return f === fa ? new ab(lc(f.e).subscribe(c), d) : new ab(f.subscribe(c), d);
      });
    }, Cb.amb = function(a) {
      var b = this;
      return new Hc(function(c) {
        ...
        return i.setDisposable(b.subscribe(k)), j.setDisposable(a.subscribe(l)), new ab(i, j);
      });
    }, Ib.amb = function() {
      var a,
          b = ec();
    ...
    Cb["catch"] = function(a) {
      return ea(a) ? F(this, a) : nc([this, a]);
    };
    var nc = Ib["catch"] = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
    ...
    var oc = Ib.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = ea(b[a - 1]) ? b.pop() : H;
      return Array.isArray(b[0]) && (b = b[0]), new Hc(function(a) {
        function c(b) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new hb;
            da(f) && (f = Tb(f)), g.setDisposable(f.subscribe(function(a) {
              j[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    Cb.concat = function() {
      for (var a = [],
        ...
        a.push(arguments[b]);
      return a.unshift(this), qc.apply(null, a);
    };
    var pc = function(a) {
      function b(b) {
        this.sources = b, a.call(this);
      ...
      return Za(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = qb.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
    ...
    var rc = function(a) {
      ...
      return Za(b, a), b.prototype.subscribeCore = function(a) {
        var b = new ab;
        return b.add(this.source.subscribe(new sc(a, this.maxConcurrent, b))), b;
      }, b;
    }(Jb),
        sc = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new hb;
            this.g.add(c), da(a) && (a = Tb(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    Cb.merge = function(a) {
      return "number" != typeof a ? tc(this, a) : new rc(this, a);
    };
    var tc = Ib.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      ...
      return Array.isArray(c[0]) && (c = c[0]), B(a, c).mergeAll();
        ...
        uc = Y.CompositeError = function(a) {
    ...
    uc.prototype = Error.prototype, Ib.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new Hc(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : 1 === g.length ? a.onError(g[0]) : a.onError(new uc(g));
        }
        var c = new ab,
            e = new hb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new hb;
          c.add(e), da(d) && (d = Tb(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    var vc = function(a) {
      ...
      return Za(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new hb;
          this.g.add(b), da(a) && (a = Tb(a)), b.setDisposable(a.subscribe(new d(this, b)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    Cb.mergeAll = function() {
      return new vc(this);
    }, Cb.onErrorResumeNext = function(a) {
      if (!a)
        throw new Error("Second observable is required");
      return wc([this, a]);
    };
    var wc = Ib.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new Hc(function(b) {
        var c = 0,
            d = new ib,
            e = qb.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], da(f) && (f = Tb(f)), g = new hb, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new ab(d, e);
      });
    };
    ...
    var xc = function(a) {
      ...
      return Za(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new hb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), da(a) && (a = Tb(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    var yc = function(a) {
      function b(b, c) {
        this.source = b, this.other = da(c) ? Tb(c) : c, a.call(this);
      }
      function c(a) {
        this.o = a, this.isStopped = !1;
      }
      return Za(b, a), b.prototype.subscribeCore = function(a) {
        return new ab(this.source.subscribe(a), this.other.subscribe(new c(a)));
      }, c.prototype.onNext = function(a) {
    ...
    Cb.takeUntil = function(a) {
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Hc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new hb;
            da(d) && (d = Tb(d)), e.setDisposable(d.subscribe(function(a) {
      ...
      var e = this;
      return b.unshift(e), new Hc(function(a) {
        for (var c = b.length,
            f = p(c, I),
            g = p(c, G),
            h = new Array(c),
          ...
          !function(c) {
            var i = b[c],
                j = new hb;
            da(i) && (i = Tb(i)), j.setDisposable(i.subscribe(function(b) {
      ...
      return b.unshift(e), new Hc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var i = b[c],
                j = new hb;
            (wa(i) || va(i)) && (i = _b(i)), j.setDisposable(i.subscribe(function(b) {
              if (f[c].push(b), f.every(function(a) {
                return a.length > 0;
              })) {
                var h = f.map(function(a) {
      ...
      return new Hc(J(this), this);
    }, Cb.bufferWithCount = function(a, b) {
    ...
    var zc = function(a) {
      ...
      return Za(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Ac(a, this.keyFn, this.comparer));
      }, b;
    }(Jb),
        Ac = function(a) {
          function b(b, c, d) {
    ...
    var Bc = function(a) {
      ...
      function c(a, b) {
        this.o = a, this.t = !b._oN || ea(b._oN) ? Bb(b._oN || Z, b._oE || Z, b._oC || Z) : b._oN, this.isStopped = !1;
      }
      return Za(b, a), b.prototype.subscribeCore = function(a) {
    ...
    Cb["do"] = Cb.tap = Cb.doAction = function(a, b, c) {
      ...
      return new Hc(function(c) {
        ...
        return e === fa ? (a(), d(e.e)) : db(function() {
    ...
    Cb.ignoreElements = function() {
      ...
      return new Hc(function(b) {
        return a.subscribe(function(a) {
          ...
          b.onNext(yb(a)), b.onCompleted();
        }, function() {
          b.onNext(zb()), b.onCompleted();
        });
      }, a);
    }, Cb.repeat = function(a) {
      return Pb(this, a).concat();
    }, Cb.retry = function(a) {
      return Pb(this, a).catchError();
    }, Cb.retryWhen = function(a) {
      return Pb(this).catchErrorWhen(a);
    };
    var Dc = function(a) {
      function b(b, c, d, e) {
    ...
    M.prototype = {
      ...
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new Dc(this, c, b, a);
      ...
      var a,
          b = 0;
      arguments.length && nb(arguments[0]) ? (a = arguments[0], b = 1) : a = qb;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Rb([bc(c, a), this]).concat();
      ...
      return new Kb(this, a, b, c).merge(1);
    }, Cb.concatMapObserver = Cb.selectConcatObserver = function(a, b, c, d) {
      var e = this,
          f = ya(a, d, 2),
          g = ya(b, d, 1),
          h = ya(c, d, 0);
      return new Hc(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          da(c) && (c = Tb(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          da(b) && (b = Tb(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, Cb.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new Hc(function(a) {
        var d = !1;
    ...
    }, Cb.distinct = function(a, b) {
      var c = this;
      return b || (b = aa), new Hc(function(d) {
        var e = new O(b);
        return c.subscribe(function(b) {
          var c = b;
          if (a)
    ...
    Cb.map = Cb.select = function(a, b) {
      ...
      return this instanceof Ec ? this.internalMap(c, b) : new Ec(this, c, b);
    }, Cb.pluck = function() {
    ...
    }, Cb.flatMapObserver = Cb.selectManyObserver = function(a, b, c, d) {
      var e = this;
      return new Hc(function(f) {
        var g = 0;
        return e.subscribe(function(b) {
          ...
          da(c) && (c = Tb(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          da(a) && (a = Tb(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    }, Cb.flatMap = Cb.selectMany = function(a, b, c) {
      return new Kb(this, a, b, c).mergeAll();
    }, Y.Observable.prototype.flatMapLatest = function(a, b, c) {
      return new Kb(this, a, b, c).switchLatest();
    };
    var Fc = function(a) {
      function b(b, c) {
    ...
    Cb.filter = Cb.where = function(a, b) {
      return this instanceof Gc ? this.internalFilter(a, b) : new Gc(this, a, b);
    ...
    var Hc = Y.AnonymousObservable = function(a) {
      function b(a) {
        return a && ea(a.dispose) ? a : ea(a) ? db(a) : eb;
      }
      function c(a, c) {
    ...
    var Kc = Y.Subject = function(a) {
      function c(a) {
        return gb(this), this.isStopped ? this.hasError ? (a.onError(this.error), eb) : (a.onCompleted(), eb) : (this.observers.push(a), new Jc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return Za(d, a), $a(d.prototype, Ab.prototype, {
        ...
        Lc = (Y.AsyncSubject = function(a) {
          function c(a) {
            return gb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), eb) : (this.observers.push(a), new Jc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return Za(d, a), $a(d.prototype, Ab, {
            hasObservers: function() {
        ...
        }(Ib), Y.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return Za(c, a), $a(c.prototype, Ab.prototype, {
            onCompleted: function() {
