...
(function(process) {
  (function(a) {
    ...
    function e(a, b) {
      if (Xa && b.stack && "object" == typeof a && null !== a && a.stack && -1 === a.stack.indexOf(_a)) {
        for (var c = [],
            d = b; d; d = d.source)
    ...
    function k(a) {
      ...
      if (!Jb(a))
        return b;
      Ib.nonEnumArgs && a.length && Kb(a) && (a = Mb.call(a));
    ...
    function o(a, b, c, d) {
      ...
      if (!i) {
        if (g != wb || !Ib.nodeClass && (n(a) || n(b)))
          return !1;
        var j = !Ib.argsObject && Kb(a) ? Object : a.constructor,
            k = !Ib.argsObject && Kb(b) ? Object : b.constructor;
        if (!(j == k || Ab.call(a, "constructor") && Ab.call(b, "constructor") || Ua(j) && j instanceof j && Ua(k) && k instanceof k || !("constructor" in a && "constructor" in b)))
          return !1;
      }
      c || (c = []), d || (d = []);
    ...
    function y(b) {
      ...
      if (!d && "string" == typeof b)
        return c = new t(b), c[hb]();
      if (!d && b.length !== a)
        return c = new v(b), c[hb]();
      if (!d)
    ...
    function A(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && x(b) ? (b = z(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > Vc ? Vc : b) : b;
    }
    function B(a, b) {
      this.observer = a, this.parent = b;
    }
    function C(a, b) {
      return fc(a) || (a = kc), new Xc(b, a);
    }
    function D(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function G(a, b) {
      return new ae(function(c) {
        var d = new _b,
            e = new ac;
        return e.setDisposable(d), d.setDisposable(a.subscribe(new hd(c, e, b))), e;
      }, a);
    }
    function H() {
      return !1;
    ...
    function U(a) {
      return a ? Cc.isObservable(a) ? a : Ta(a) ? Cc.fromPromise(a) : Z(a) || Y(a) ? Id.call(this, a) : Ua(a) ? X.call(this, a) : kb(a) || jb(a) ? V.call(this, a) : Jb(a) ? W.call(this, a) : a : a;
    }
    function V(a) {
      return Cc.from(a).flatMap(U).toArray();
    }
    function W(b) {
      function c(b, c) {
      ...
      for (var d = new b.constructor,
        ...
        var i = e[g],
            j = U.call(this, b[i]);
        j && Cc.isObservable(j) ? c(j, i) : d[i] = b[i];
      }
      return Cc.forkJoin.apply(Cc, f).map(function() {
        return d;
      });
    }
    function X(a) {
    ...
    function Y(a) {
      return Ua(a.next) && Ua(a["throw"]);
    }
    function Z(a) {
      var b = a.constructor;
      return b ? "GeneratorFunction" === b.name || "GeneratorFunction" === b.displayName ? !0 : Y(b.prototype) : !1;
    }
    function $(a, b, c, d) {
      var e = new ee;
    ...
    function ha(a, b, c) {
      return a.addEventListener ? new ea(a, b, c) : a.attachEvent ? new fa(a, b, c) : ga(a, b, c);
    }
    function ia(a, b, c) {
      var d = new Ub;
      if (ca(a) || "[object HTMLCollection]" === Object.prototype.toString.call(a))
        for (var e = 0,
            f = a.length; f > e; e++)
          d.add(ia(a.item(e), b, c));
      else
        a && d.add(ha(a, b, c));
      return d;
    }
    ...
    function ka(a, b) {
      return a.groupJoin(this, b, Sc, function(a, b) {
        return b;
      });
    }
    function la(a) {
      ...
      return new ae(function(c) {
        var d = new de,
            e = new Ub,
            f = new bc(e);
        return c.onNext(Pb(d, f)), e.add(b.subscribe(function(a) {
          d.onNext(a);
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
        })), Ta(a) && (a = Nc(a)), e.add(a.subscribe(function(a) {
          d.onCompleted(), d = new de, c.onNext(Pb(d, f));
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
    ...
    function ma(a) {
      ...
      return new ae(function(c) {
        function d() {
          ...
          Ta(b) && (b = Nc(b));
          var i = new _b;
          e.setDisposable(i), i.setDisposable(b.take(1).subscribe(Na, function(a) {
            h.onError(a), c.onError(a);
          }, function() {
            h.onCompleted(), h = new de, c.onNext(Pb(h, g)), d();
          }));
        }
        var e = new ac,
            f = new Ub(e),
            g = new bc(f),
            h = new de;
        return c.onNext(Pb(h, g)), f.add(b.subscribe(function(a) {
          h.onNext(a);
        }, function(a) {
          h.onError(a), c.onError(a);
        }, function() {
    ...
    function ra(a, b, c) {
      this.joinObserverArray = a, this.onNext = b, this.onCompleted = c, this.joinObservers = new Yd;
      for (var d = 0,
    ...
    function ua(a, b) {
      return new ae(function(c) {
        return b.scheduleWithRelative(ec(a), function() {
          c.onNext(0), c.onCompleted();
        });
      });
    }
    function va(a, b, c) {
      return a === b ? new ae(function(a) {
        return c.schedulePeriodicWithState(0, b, function(b) {
          return a.onNext(b), b + 1;
        });
      }) : Pc(function() {
        return ta(c.now() + a, b, c);
      });
    }
    function wa(a, b, c) {
      return new ae(function(d) {
        ...
        return e = a.materialize().timestamp(c).subscribe(function(a) {
          ...
          }), k = !f, f = !0), k && (null !== h ? d.onError(h) : (e = new _b, g.setDisposable(e), e.setDisposable(c.scheduleRecursiveWithRelative(b, function(a) {
            var b,
                e,
                g,
                k;
 ...
 while (null !== g);
    ...
    function ya(a, b, c) {
      var d,
          e;
      return Ua(b) ? e = b : (d = b, e = c), new ae(function(b) {
        function c() {
    ...
    function za(a, b, c) {
      return fc(c) || (c = oc), new ae(function(d) {
        var e,
            f = new ac,
            g = !1,
            h = 0,
            i = a.subscribe(function(a) {
              ...
              var i = h,
                  j = new _b;
              f.setDisposable(j), j.setDisposable(c.scheduleWithRelative(b, function() {
    ...
    function Ca(a, b, c, d) {
      return Ua(b) && (d = c, c = b, b = _c()), d || (d = gd(new _d)), new ae(function(e) {
        function f(a) {
          var b = k,
              c = new _b;
          i.setDisposable(c), c.setDisposable(a.subscribe(function() {
    ...
    function Da(a, b, c, d) {
      ...
      fc(c) && (d = c, c = gd(new _d)), c instanceof Error && (c = gd(c)), fc(d) || (d = oc);
      var e = b instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new ae(function(f) {
        function g() {
          var a = h;
          l.setDisposable(d[e](b, function() {
            h === a && (Ta(c) && (c = Nc(c)), j.setDisposable(c.subscribe(f)));
          }));
        }
        var h = 0,
            i = new _b,
            ...
            k = !1,
            l = new ac;
        return j.setDisposable(i), g(), i.setDisposable(a.subscribe(function(a) {
          k || (h++, f.onNext(a), g());
        }, function(a) {
          k || (h++, f.onError(a));
        }, function() {
    ...
    var Za,
        $a = i(),
        _a = "From previous event:",
        ab = Ma.EmptyError = function() {
    ...
    var bb = Ma.ObjectDisposedError = function() {
    ...
    var cb = Ma.ArgumentOutOfRangeError = function() {
    ...
    var db = Ma.NotSupportedError = function(a) {
    ...
    var eb = Ma.NotImplementedError = function(a) {
    ...
    var fb = Ma.helpers.notImplemented = function() {
      throw new eb;
    },
        gb = Ma.helpers.notSupported = function() {
          throw new db;
        },
        hb = "function" == typeof Symbol && Symbol.iterator || "_es6shim_iterator_";
    La.Set && "function" == typeof(new La.Set)["@@iterator"] && (hb = "@@iterator");
    var ib = Ma.doneEnumerator = {
      done: !0,
      value: a
    },
        jb = Ma.helpers.isIterable = function(b) {
          return b[hb] !== a;
        },
        kb = Ma.helpers.isArrayLike = function(b) {
          return b && b.length !== a;
        };
    Ma.helpers.iterator = hb;
    var lb,
        mb = Ma.internals.bindCallback = function(a, b, c) {
    ...
    var Jb = Ma.internals.isObject = function(a) {
      var b = typeof a;
    ...
    var Lb = Ma.internals.isEqual = function(a, b) {
      return o(a, b, [], []);
    },
        Mb = ({}.hasOwnProperty, Array.prototype.slice),
        Nb = Ma.internals.inherits = function(a, b) {
          function c() {
            this.constructor = a;
          }
          c.prototype = b.prototype, a.prototype = new c;
        },
        Ob = Ma.internals.addProperties = function(a) {
          for (var b = [],
              c = 1,
        ...
        Pb = Ma.internals.addRef = function(a, b) {
          return new ae(function(c) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(a) {
      var b = this,
          c = Mb.call(arguments, 1),
          d = function() {
            function e() {}
            if (this instanceof d) {
              e.prototype = b.prototype;
              var f = new e,
                  g = b.apply(f, c.concat(Mb.call(arguments)));
              return Object(g) === g ? g : f;
            }
            return b.apply(a, c.concat(Mb.call(arguments)));
          };
      return d;
    ...
    Array.prototype.every || (Array.prototype.every = function(a) {
      var b = Object(this),
          c = Rb && zb.call(this) === yb ? this.split("") : b,
          d = c.length >>> 0,
          e = arguments[1];
      if (zb.call(a) !== ub)
        throw new TypeError(a + " is not a function");
    ...
    var Sb = Ma.internals.PriorityQueue = function(a) {
    ...
    Tb.isHigherPriority = function(a, b) {
      ...
      var b = this.length++;
      this.items[b] = new q(Sb.count++, a), this.percolate(b);
    ...
    var Ub = Ma.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var Wb = Ma.Disposable = function(a) {
    ...
    var Xb = Wb.create = function(a) {
      return new Wb(a);
        ...
        Yb = Wb.empty = {dispose: Na},
        Zb = Wb.isDisposable = function(a) {
          return a && Ua(a.dispose);
        },
        $b = Wb.checkDisposed = function(a) {
          if (a.isDisposed)
            throw new bb;
        },
        _b = Ma.SingleAssignmentDisposable = function() {
    ...
    var ac = Ma.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var bc = Ma.RefCountDisposable = function() {
      function a(a) {
    ...
    var cc = Ma.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || Ra, this.disposable = new _b;
    };
    cc.prototype.invoke = function() {
      this.disposable.setDisposable(this.invokeCore());
    }, cc.prototype.compareTo = function(a) {
      return this.comparer(this.dueTime, a.dueTime);
    }, cc.prototype.isCancelled = function() {
      return this.disposable.isDisposed;
    }, cc.prototype.invokeCore = function() {
      return this.action(this.scheduler, this.state);
    };
    var dc = Ma.Scheduler = function() {
      function a(a, b, c, d) {
      ...
      }, a.now = Pa, a.normalize = function(a) {
        return 0 > a && (a = 0), a;
      }, a;
    }(),
        ec = dc.normalize,
    ...
    !function(a) {
      function b(a, b) {
        function c(b) {
          function d(a, b) {
            return g ? f.remove(i) : h = !0, e(b, c), Yb;
          }
          var g = !1,
              h = !1,
      ...
      function c(a, b, c) {
        function d(b, e) {
          function h(a, b) {
            return i ? g.remove(k) : j = !0, f(b, d), Yb;
          }
          var i = !1,
              j = !1,
              k = a[c](b, e, h);
      ...
      dc.prototype.schedulePeriodic = function(a, b) {
        return this.schedulePeriodicWithState(null, a, b);
      }, dc.prototype.schedulePeriodicWithState = function(a, b, c) {
    ...
    var gc,
        hc,
        ic = Ma.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
        ...
        jc = dc.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new dc(Pa, a, gb, gb);
        }(),
        kc = dc.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.shift();
          ...
          function b(b, e) {
            var f = new cc(this, b, e, this.now());
            if (c)
              c.push(f);
            else {
              c = [f];
          ...
          var c,
              e = new dc(Pa, b, gb, gb);
          return e.scheduleRequired = function() {
            return !c;
          }, e;
        }(),
        lc = function() {
    ...
    !function() {
      ...
      var h = RegExp("^" + String(zb).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
      ...
      if (Ua(i))
        ...
        La.addEventListener ? La.addEventListener("message", c, !1) : La.attachEvent ? La.attachEvent("onmessage", c) : La.onmessage = c, gc = function(a) {
          var b = e++;
        ...
        gc = "document" in La && "onreadystatechange" in La.document.createElement("script") ? function(b) {
          ...
          var c = e++;
          return f[c] = b, mc(function() {
            a(c);
          }, 0), c;
        };
    }();
    var oc = dc.timeout = dc["default"] = function() {
      function a(a, b) {
        var c = this,
            d = new _b,
            e = gc(function() {
      ...
      return new dc(Pa, a, b, c);
        ...
        pc = function(a) {
          ...
          return Nb(e, a), e.prototype._clone = function(a) {
        ...
        qc = Ma.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return fc(a) || (a = jc), new ae(function(c) {
        ...
        rc = qc.createOnNext = function() {
          ...
          return function(d) {
            return new qc("N", d, null, a, b, c);
          };
        }(),
        sc = qc.createOnError = function() {
          function a(a, b) {
          ...
          return function(d) {
            return new qc("E", null, d, a, b, c);
          };
        }(),
        tc = qc.createOnCompleted = function() {
          function a(a, b, c) {
            return c();
          }
          function b(a) {
          ...
          return function() {
            return new qc("C", null, null, a, b, c);
          };
        }(),
        uc = Ma.Observer = function() {};
    uc.prototype.toNotifier = function() {
      var a = this;
      return function(b) {
        return b.accept(a);
      };
    }, uc.prototype.asObserver = function() {
      var a = this;
    ...
    }, uc.prototype.checked = function() {
      return new zc(this);
    };
    var vc = uc.create = function(a, b, c) {
      return a || (a = Na), b || (b = Sa), c || (c = Na), new yc(a, b, c);
    };
    uc.fromNotifier = function(a, b) {
      var c = mb(a, b, 1);
    ...
    }, uc.prototype.notifyOn = function(a) {
      return new Bc(a, this);
    }, uc.prototype.makeSafe = function(a) {
      return new AnonymousSafeObserver(this._onNext, this._onError, this._onCompleted, a);
    };
    var wc,
        xc = Ma.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
          return Nb(b, a), b.prototype.next = fb, b.prototype.error = fb, b.prototype.completed = fb, b.prototype.onNext = function(a) {
        ...
        yc = Ma.AnonymousObserver = function(a) {
          function b(b, c, d) {
            a.call(this), this._onNext = b, this._onError = c, this._onCompleted = d;
          }
          return Nb(b, a), b.prototype.next = function(a) {
            this._onNext(a);
        ...
        zc = function(a) {
          ...
          return c.onNext = function(a) {
            this.checkAccess();
            var b = Wa(this._observer.onNext).call(this._observer, a);
            this._state = 0, b === Va && d(b.e);
          }, c.onError = function(a) {
            this.checkAccess();
            var b = Wa(this._observer.onError).call(this._observer, a);
            this._state = 2, b === Va && d(b.e);
          }, c.onCompleted = function() {
            this.checkAccess();
            var a = Wa(this._observer.onCompleted).call(this._observer);
            this._state = 2, a === Va && d(a.e);
        ...
        Ac = Ma.internals.ScheduledObserver = function(a) {
          function b(b, c) {
        ...
        Bc = function(a) {
          ...
          return Nb(b, a), b.prototype.next = function(b) {
        ...
        Cc = Ma.Observable = function() {
          ...
          function b(b) {
            if (Ma.config.longStackSupport && Xa) {
              var c = Wa(d)(new Error).e;
              this.stack = c.stack.substring(c.stack.indexOf("\n") + 1), this._subscribe = a(this, b);
            } else
              this._subscribe = b;
          }
          return wc = b.prototype, b.isObservable = function(a) {
            return a && Ua(a.subscribe);
          }, wc.subscribe = wc.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : vc(a, b, c));
          }, wc.subscribeOnNext = function(a, b) {
            return this._subscribe(vc("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, wc.subscribeOnError = function(a, b) {
            return this._subscribe(vc(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, wc.subscribeOnCompleted = function(a, b) {
            return this._subscribe(vc(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, b;
        }(),
        Dc = Ma.ObservableBase = function(a) {
          function b(a) {
            return a && Ua(a.dispose) ? a : Ua(a) ? Xb(a) : Yb;
          }
          function c(a, c) {
            var e = c[0],
                f = c[1],
                g = Wa(f.subscribeCore).call(f, e);
            return g !== Va || e.fail(Va.e) ? void e.setDisposable(b(g)) : d(Va.e);
          }
          function e(a) {
            var b = new be(a),
                d = [b, this];
            return kc.scheduleRequired() ? kc.scheduleWithState(d, c) : c(null, d), b;
          }
          function f() {
            a.call(this, e);
          }
          return Nb(f, a), f.prototype.subscribeCore = fb, f;
        }(Cc),
        Ec = function(a) {
          function b(b, c, d, e) {
            this.resultSelector = Ma.helpers.isFunction(d) ? d : null, this.selector = Ma.internals.bindCallback(Ma.helpers.isFunction(c) ? c : function() {
              return c;
          ...
          return Nb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              ...
              Ma.helpers.isPromise(c) && (c = Ma.Observable.fromPromise(c)), (Ma.helpers.isArrayLike(c) || Ma.helpers.isIterable(c)) && (c = Ma.Observable.from(c)), this.o.onNext(this._wrapResult(c, a, b));
            }
        ...
        Fc = Ma.internals.Enumerable = function() {},
        Gc = function(a) {
          function b(b) {
          ...
          return Nb(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                d = new ac,
                e = jc.scheduleRecursiveWithState(this.sources[hb](), function(e, f) {
                  if (!b) {
    ...
    var Hc = function(a) {
      ...
      return Nb(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[hb](),
            d = new ac,
            e = jc.scheduleRecursiveWithState(null, function(e, f) {
              if (!b) {
                var g = Wa(c.next).call(c);
                if (g === Va)
                  return a.onError(g.e);
                if (g.done)
                  return null !== e ? a.onError(e) : a.onCompleted();
                var h = g.value;
                Ta(h) && (h = Nc(h));
                var i = new _b;
                d.setDisposable(i), i.setDisposable(h.subscribe(function(b) {
                  a.onNext(b);
                }, f, function() {
                  a.onCompleted();
                }));
    ...
    Fc.prototype.catchError = function() {
      return new Hc(this);
    }, Fc.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new ae(function(c) {
        var d,
            e,
            ...
            j = b[hb](),
            k = new ac,
            l = jc.scheduleRecursive(function(a) {
              if (!d) {
                var b = Wa(j.next).call(j);
                if (b === Va)
                ...
                var i = new _b,
                    l = new _b;
                k.setDisposable(new Ub(l, i)), i.setDisposable(h.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
        ...
        return new Ub(i, k, l, Xb(function() {
          d = !0;
        }));
      });
    };
    var Ic = function(a) {
      ...
      return Nb(b, a), b.prototype[hb] = function() {
        return new c(this);
        ...
        Lc = Fc.of = function(a, b, c) {
          return new Kc(a, b, c);
        };
    wc.observeOn = function(a) {
      var b = this;
      return new ae(function(c) {
        return b.subscribe(new Bc(a, c));
      }, b);
    }, wc.subscribeOn = function(a) {
      var b = this;
      return new ae(function(c) {
        var d = new _b,
            e = new ac;
    ...
    var Mc = function(a) {
      ...
      return Nb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Nc = Cc.fromPromise = function(a) {
          return new Mc(a);
        };
    wc.toPromise = function(a) {
      if (a || (a = Ma.config.Promise), !a)
        throw new db("Promise type not provided nor in Rx.config.Promise");
      var b = this;
    ...
    wc.toArray = function() {
      return new Oc(this);
    }, Cc.create = function(a, b) {
      return new ae(a, b);
    };
    var Pc = Cc.defer = function(a) {
      return new ae(function(b) {
        var c;
        try {
          c = a();
        } catch (d) {
          return gd(d).subscribe(b);
        }
        return Ta(c) && (c = Nc(c)), c.subscribe(b);
      });
    },
        Qc = function(a) {
          function b(b) {
        ...
        Rc = new Qc(jc),
        Sc = Cc.empty = function(a) {
          return fc(a) || (a = jc), a === jc ? Rc : new Qc(a);
        },
        Tc = function(a) {
          function b(b, c, d) {
    ...
    var Wc = Cc.from = function(a, b, c, d) {
      if (null == a)
    ...
    var Yc = Cc.fromArray = function(a, b) {
      return fc(b) || (b = kc), new Xc(a, b);
    };
    Cc.generate = function(a, b, c, d, e) {
      return fc(e) || (e = kc), new ae(function(f) {
        var g = !0;
    ...
    D.prototype.run = function() {
      ...
      var b = this.observer,
          ...
          e = d.length;
      return this.parent.scheduler.scheduleRecursiveWithState(0, a);
    }, Cc.pairs = function(a, b) {
      return b || (b = kc), new ad(a, b);
    };
    var bd = function(a) {
      function b(b, c, d) {
    ...
    Cc.range = function(a, b, c) {
      return fc(c) || (c = kc), new bd(a, b, c);
    };
    var dd = function(a) {
      function b(b, c, d) {
    ...
    var ed = function(a) {
      ...
      function d(a, b) {
        var c = b[0],
            d = b[1];
        return d.onNext(c), d.onCompleted(), Yb;
      }
      return Nb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return this.scheduler === jc ? d(null, a) : this.scheduler.scheduleWithState(a, d);
      }, b;
    }(Dc),
        fd = (Cc["return"] = Cc.just = function(a, b) {
          return fc(b) || (b = jc), new ed(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        gd = Cc["throw"] = function(a, b) {
          return fc(b) || (b = jc), new fd(a, b);
        };
    Cc.using = function(a, b) {
      return new ae(function(c) {
        var d = Yb,
            e = Wa(a)();
        if (e === Va)
          return new Ub(gd(e.e).subscribe(c), d);
        e && (d = e);
        var f = Wa(b)(e);
        return f === Va ? new Ub(gd(f.e).subscribe(c), d) : new Ub(f.subscribe(c), d);
      });
    }, wc.amb = function(a) {
      var b = this;
      return new ae(function(c) {
        ...
        return i.setDisposable(b.subscribe(k)), j.setDisposable(a.subscribe(l)), new Ub(i, j);
      });
    }, Cc.amb = function() {
      var a,
          b = _c();
    ...
    wc["catch"] = function(a) {
      return Ua(a) ? G(this, a) : id([this, a]);
    };
    var id = Cc["catch"] = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return Lc(a).catchError();
    };
    wc.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      return Array.isArray(b[0]) ? b[0].unshift(this) : b.unshift(this), jd.apply(this, b);
    };
    var jd = Cc.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = Ua(b[a - 1]) ? b.pop() : I;
      return Array.isArray(b[0]) && (b = b[0]), new ae(function(a) {
        function c(b) {
          if (g[b] = !0, h || (h = g.every(Oa))) {
            try {
        ...
        function e(b) {
          i[b] = !0, i.every(Oa) && a.onCompleted();
        }
        for (var f = b.length,
            g = p(f, H),
            h = !1,
          ...
          !function(d) {
            var f = b[d],
                g = new _b;
            Ta(f) && (f = Nc(f)), g.setDisposable(f.subscribe(function(a) {
              j[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    wc.concat = function() {
      for (var a = [],
        ...
        a.push(arguments[b]);
      return a.unshift(this), ld.apply(null, a);
    };
    var kd = function(a) {
      function b(b) {
        this.sources = b, a.call(this);
      ...
      return Nb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = jc.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
        ...
        return new Ub(b, f, Xb(function() {
          a = !0;
        }));
      }, b;
    }(Dc),
        ld = Cc.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
    ...
    var md = function(a) {
      ...
      return Nb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new Ub;
        return b.add(this.source.subscribe(new nd(a, this.maxConcurrent, b))), b;
      }, b;
    }(Dc),
        nd = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new _b;
            this.g.add(c), Ta(a) && (a = Nc(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    wc.merge = function(a) {
      return "number" != typeof a ? od(this, a) : new md(this, a);
    };
    var od = Cc.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      ...
      return Array.isArray(c[0]) && (c = c[0]), C(a, c).mergeAll();
        ...
        pd = function(a) {
          ...
          return Nb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = new _b;
              this.g.add(b), Ta(a) && (a = Nc(a)), b.setDisposable(a.subscribe(new d(this, b)));
            }
          }, c.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, c.prototype.onCompleted = function() {
    ...
    wc.mergeAll = function() {
      return new pd(this);
    };
    var qd = Ma.CompositeError = function(a) {
    ...
    qd.prototype = Error.prototype, Cc.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new ae(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : 1 === g.length ? a.onError(g[0]) : a.onError(new qd(g));
        }
        var c = new Ub,
            e = new _b,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new _b;
          c.add(e), Ta(d) && (d = Nc(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    }, wc.onErrorResumeNext = function(a) {
      if (!a)
        throw new Error("Second observable is required");
      return rd([this, a]);
    };
    var rd = Cc.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new ae(function(b) {
        var c = 0,
            ...
            e = jc.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], Ta(f) && (f = Nc(f)), g = new _b, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new Ub(d, e);
      });
    };
    wc.skipUntil = function(a) {
      var b = this;
      return new ae(function(c) {
        var d = !1,
            e = new Ub(b.subscribe(function(a) {
              d && c.onNext(a);
            }, function(a) {
              c.onError(a);
            }, function() {
    ...
    var sd = function(a) {
      ...
      return Nb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new _b,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), Ta(a) && (a = Nc(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    wc["switch"] = wc.switchLatest = function() {
      return new sd(this);
    };
    var td = function(a) {
      function b(b, c) {
        this.source = b, this.other = Ta(c) ? Nc(c) : c, a.call(this);
      }
      function c(a) {
        this.o = a, this.isStopped = !1;
      }
      return Nb(b, a), b.prototype.subscribeCore = function(a) {
        return new Ub(this.source.subscribe(a), this.other.subscribe(new c(a)));
      }, c.prototype.onNext = function(a) {
    ...
    wc.takeUntil = function(a) {
      return new td(this, a);
    }, wc.withLatestFrom = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new ae(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new _b;
            Ta(d) && (d = Nc(d)), e.setDisposable(d.subscribe(function(a) {
              h[c] = a, f[c] = !0, g = f.every(Oa);
            }, function(b) {
              a.onError(b);
            }, Na)), i[c] = e;
          }(j);
        var k = new _b;
        return k.setDisposable(e.subscribe(function(b) {
          var c = [b].concat(h);
          if (g) {
            var e = Wa(d).apply(null, c);
            return e === Va ? a.onError(e.e) : void a.onNext(e);
          }
        }, function(b) {
          a.onError(b);
        }, function() {
      ...
      var e = this;
      return b.unshift(e), new ae(function(a) {
        for (var c = b.length,
            f = p(c, J),
            g = p(c, H),
            h = new Array(c),
          ...
          !function(c) {
            var i = b[c],
                j = new _b;
            Ta(i) && (i = Nc(i)), j.setDisposable(i.subscribe(function(b) {
      ...
      return b.unshift(e), new ae(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var i = b[c],
                j = new _b;
            (kb(i) || jb(i)) && (i = Wc(i)), j.setDisposable(i.subscribe(function(b) {
              if (f[c].push(b), f.every(function(a) {
                return a.length > 0;
              })) {
                var h = f.map(function(a) {
    ...
    }, wc.asObservable = function() {
      return new ae(K(this), this);
    }, wc.bufferWithCount = function(a, b) {
      return "number" != typeof b && (b = a), this.windowWithCount(a, b).flatMap(L).filter(M);
    }, wc.dematerialize = function() {
      var a = this;
      return new ae(function(b) {
        return a.subscribe(function(a) {
          return a.accept(b);
    ...
    wc.distinctUntilChanged = function(a, b) {
      return b || (b = Qa), new ud(this, a, b);
    };
    var wd = function(a) {
      function b(b, c, d, e) {
      ...
      function c(a, b) {
        this.o = a, this.t = !b._oN || Ua(b._oN) ? vc(b._oN || Na, b._oE || Na, b._oC || Na) : b._oN, this.isStopped = !1;
      }
      return Nb(b, a), b.prototype.subscribeCore = function(a) {
    ...
    wc["do"] = wc.tap = wc.doAction = function(a, b, c) {
      return new wd(this, a, b, c);
    }, wc.doOnNext = wc.tapOnNext = function(a, b) {
      return this.tap("undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, wc.doOnError = wc.tapOnError = function(a, b) {
      return this.tap(Na, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, wc.doOnCompleted = wc.tapOnCompleted = function(a, b) {
      return this.tap(Na, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, wc["finally"] = function(a) {
      var b = this;
      return new ae(function(c) {
        var e = Wa(b.subscribe).call(b, c);
        return e === Va ? (a(), d(e.e)) : Xb(function() {
    ...
    wc.ignoreElements = function() {
      return new xd(this);
    }, wc.materialize = function() {
      var a = this;
      return new ae(function(b) {
        return a.subscribe(function(a) {
          b.onNext(rc(a));
        }, function(a) {
          b.onNext(sc(a)), b.onCompleted();
        }, function() {
          b.onNext(tc()), b.onCompleted();
        });
      }, a);
    }, wc.repeat = function(a) {
      return Jc(this, a).concat();
    }, wc.retry = function(a) {
      return Jc(this, a).catchError();
    }, wc.retryWhen = function(a) {
    ...
    N.prototype = {
      onNext: function(a) {
        return this.isStopped ? void 0 : (!this.hasValue && (this.hasValue = !0), this.hasAccumulation ? this.accumulation = Wa(this.accumulator)(this.accumulation, a) : (this.accumulation = this.hasSeed ? Wa(this.accumulator)(this.seed, a) : a, this.hasAccumulation = !0), this.accumulation === Va ? this.o.onError(this.accumulation.e) : void this.o.onNext(this.accumulation));
      },
      onError: function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      },
      ...
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new yd(this, c, b, a);
    }, wc.skipLast = function(a) {
      if (0 > a)
        throw new cb;
      var b = this;
      return new ae(function(c) {
    ...
    }, wc.startWith = function() {
      var a,
          b = 0;
      arguments.length && fc(arguments[0]) ? (a = arguments[0], b = 1) : a = jc;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Lc([Yc(c, a), this]).concat();
    }, wc.takeLast = function(a) {
      if (0 > a)
        throw new cb;
      var b = this;
      return new ae(function(c) {
    ...
    }, wc.windowWithCount = function(a, b) {
      var c = this;
    ...
    }, wc.flatMapConcat = wc.concatMap = function(a, b, c) {
      return new Ec(this, a, b, c).merge(1);
    }, wc.concatMapObserver = wc.selectConcatObserver = function(a, b, c, d) {
      var e = this,
          f = mb(a, d, 2),
          g = mb(b, d, 1),
          h = mb(c, d, 0);
      return new ae(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          Ta(c) && (c = Nc(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          Ta(b) && (b = Nc(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, wc.defaultIfEmpty = function(b) {
      var c = this;
    ...
    }, wc.distinct = function(a, b) {
      var c = this;
      return b || (b = Qa), new ae(function(d) {
        var e = new P(b);
        return c.subscribe(function(b) {
          var c = b;
          if (a)
    ...
    }, wc.groupBy = function(a, b) {
      return this.groupByUntil(a, b, _c);
    }, wc.groupByUntil = function(b, c, d) {
      var e = this;
      return new ae(function(f) {
        var g = new Yd,
            h = new Ub,
        ...
        return h.add(e.subscribe(function(e) {
          ...
          var l = !1,
              m = g.get(k);
          if (m === a && (m = new de, g.set(k, m), l = !0), l) {
            var n = new ce(k, m, i),
                o = new ce(k, m),
                p = Wa(d)(o);
            if (p === Va)
            ...
            f.onNext(n);
            var q = new _b;
            h.add(q), q.setDisposable(p.take(1).subscribe(Na, function(a) {
          ...
          var r = e;
          return Ua(c) && (r = Wa(c)(e), r === Va) ? (g.forEach(j(r.e)), f.onError(r.e)) : void m.onNext(r);
        }, function(a) {
          g.forEach(j(a)), f.onError(a);
        }, function() {
    ...
    var zd = function(a) {
      ...
      return Nb(b, a), b.prototype.internalMap = function(a, d) {
    ...
    }, wc.flatMap = wc.selectMany = function(a, b, c) {
      return new Ec(this, a, b, c).mergeAll();
    }, wc.flatMapObserver = wc.selectManyObserver = function(a, b, c, d) {
      var e = this;
      return new ae(function(f) {
        var g = 0;
        return e.subscribe(function(b) {
          ...
          Ta(c) && (c = Nc(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          Ta(a) && (a = Nc(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    }, Ma.Observable.prototype.flatMapLatest = function(a, b, c) {
      return new Ec(this, a, b, c).switchLatest();
    };
    var Ad = function(a) {
      function b(b, c) {
    ...
    wc.filter = wc.where = function(a, b) {
      return this instanceof Bd ? this.internalFilter(a, b) : new Bd(this, a, b);
    };
    var Cd = function(a) {
      function b(b, c, d, e) {
      ...
      return Nb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        this.isStopped || (!this.hasValue && (this.hasValue = !0), this.hasAccumulation ? this.result = Wa(this.acc)(this.result, a) : (this.result = this.hasSeed ? Wa(this.acc)(this.seed, a) : a, this.hasAccumulation = !0), this.result === Va && this.o.onError(this.result.e));
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
        this.isStopped || (this.isStopped = !0, this.hasValue && this.o.onNext(this.result), !this.hasValue && this.hasSeed && this.o.onNext(this.seed), !this.hasValue && !this.hasSeed && this.o.onError(new ab), this.o.onCompleted());
      }, c.prototype.dispose = function() {
        this.isStopped = !0;
      }, c.prototype.fail = function(a) {
        return this.isStopped ? !1 : (this.isStopped = !0, this.o.onError(a), !0);
    ...
    wc.reduce = function(a) {
      var b = !1;
      if (2 === arguments.length) {
        b = !0;
        var c = arguments[1];
      }
      return new Cd(this, a, b, c);
    };
    var Dd = function(a) {
      function b(b, c, d) {
      ...
      return Nb(b, a), b.prototype.next = function(a) {
        var b = Wa(this._fn)(a, this._i++, this._s);
        return b === Va ? this._o.onError(b.e) : void(Boolean(b) && (this._o.onNext(!0), this._o.onCompleted()));
      }, b.prototype.error = function(a) {
        this._o.onError(a);
      }, b.prototype.completed = function() {
    ...
    wc.some = function(a, b) {
      var c = this,
          d = mb(a, b, 3);
      return new ae(function(a) {
        return c.subscribe(new Dd(a, d, c));
      });
    };
    var Ed = function(a) {
      function b(b) {
      ...
      return Nb(b, a), b.prototype.next = function() {
        this._o.onNext(!1), this._o.onCompleted();
      }, b.prototype.error = function(a) {
        this._o.onError(a);
      }, b.prototype.completed = function() {
    ...
    var Fd = function(a) {
      ...
      return Nb(b, a), b.prototype.next = function(a) {
        var b = Wa(this._fn)(a, this._i++, this._s);
        return b === Va ? this._o.onError(b.e) : void(Boolean(b) || (this._o.onNext(!1), this._o.onCompleted()));
      }, b.prototype.error = function(a) {
        this._o.onError(a);
      }, b.prototype.completed = function() {
        this._o.onNext(!0), this._o.onCompleted();
    ...
    wc.every = function(a, b) {
      var c = this,
          d = mb(a, b, 3);
      return new ae(function(a) {
        return c.subscribe(new Fd(a, d, c));
      }, this);
    }, wc.includes = function(a, b) {
      function c(a, b) {
      ...
      return new ae(function(e) {
        var f = 0,
            g = +b || 0;
        return Math.abs(g) === 1 / 0 && (g = 0), 0 > g ? (e.onNext(!1), e.onCompleted(), Yb) : d.subscribe(function(b) {
    ...
    }, wc.contains = function(a, b) {
      wc.includes(a, b);
    }, wc.count = function(a, b) {
      ...
      return new ae(function(d) {
        var e = 0,
            f = +b || 0;
        return Math.abs(f) === 1 / 0 && (f = 0), 0 > f ? (d.onNext(-1), d.onCompleted(), Yb) : c.subscribe(function(b) {
      ...
      return a && Ua(a) ? this.map(a, b).sum() : this.reduce(function(a, b) {
        return a + b;
      }, 0);
    }, wc.minBy = function(a, b) {
      return b || (b = Ra), R(this, a, function(a, c) {
        return -1 * b(a, c);
      });
    }, wc.min = function(a) {
      return this.minBy(Oa, a).map(function(a) {
        return S(a);
      });
    }, wc.maxBy = function(a, b) {
      return b || (b = Ra), R(this, a, b);
    }, wc.max = function(a) {
      return this.maxBy(Oa, a).map(function(a) {
        return S(a);
      });
    };
    var Gd = function(a) {
      ...
      return Nb(b, a), b.prototype.next = function(a) {
        if (this._fn) {
          var b = Wa(this._fn)(a, this._c++, this._s);
          if (b === Va)
            return this._o.onError(b.e);
          this._t += b;
        } else
        ...
        return 0 === this._c ? this._o.onError(new ab) : (this._o.onNext(this._t / this._c), void this._o.onCompleted());
      }, b;
    }(xc);
    wc.average = function(a, b) {
      var c,
          d = this;
      return Ua(a) && (c = mb(a, b, 3)), new ae(function(a) {
        return d.subscribe(new Gd(a, c, d));
      }, d);
    }, wc.sequenceEqual = function(a, b) {
      var c = this;
      return b || (b = Qa), new ae(function(d) {
        var e = !1,
            f = !1,
      ...
      return new ae(function(e) {
        ...
        return d.subscribe(function(a) {
          ...
          c === a ? e.onError(new cb) : (e.onNext(c), e.onCompleted());
        });
      }, d);
    }, wc.single = function(a, b) {
      if (Ua(a))
    ...
    var Hd = function(b) {
      ...
      return Nb(c, b), c.prototype.next = function(a) {
        if (this._obj.predicate) {
          var b = Wa(this._obj.predicate)(a, this._i++, this._s);
          if (b === Va)
            return this._o.onError(b.e);
        ...
        this._obj.defaultValue === a ? this._o.onError(new ab) : (this._o.onNext(this._obj.defaultValue), this._o.onCompleted());
      }, c;
    }(xc);
    wc.first = function() {
      var a = {},
      ...
      if (a = "object" == typeof arguments[0] ? arguments[0] : {
        ...
        var c = a.predicate;
        a.predicate = mb(c, a.thisArg, 3);
      }
      return new ae(function(c) {
        return b.subscribe(new Hd(c, a, b));
      }, b);
    }, wc.last = function() {
      var b = {},
          c = this;
      ...
      return new ae(function(d) {
        ...
        return c.subscribe(function(a) {
          if (b.predicate) {
            var h = Wa(b.predicate)(a, g++, c);
            if (h === Va)
              return d.onError(h.e);
            h && (f = !0, e = a);
          } else
            b.predicate || (f = !0, e = a);
        }, function(a) {
          ...
          f ? (d.onNext(e), d.onCompleted()) : b.defaultValue === a ? d.onError(new ab) : (d.onNext(b.defaultValue), d.onCompleted());
        });
      }, c);
    }, wc.find = function(a, b) {
      return T(this, a, b, !1);
    }, wc.findIndex = function(a, b) {
      return T(this, a, b, !0);
    }, wc.toSet = function() {
      if ("undefined" == typeof La.Set)
        throw new TypeError;
      var a = this;
      return new ae(function(b) {
        var c = new La.Set;
    ...
    }, wc.toMap = function(a, b) {
      if ("undefined" == typeof La.Map)
        throw new TypeError;
      var c = this;
      return new ae(function(d) {
        var e = new La.Map;
      ...
      function b() {
        return Cc.spawn.call(this, a.apply(this, arguments));
      }
      return b.__generatorFunction__ = a, b;
    };
    var Id = Cc.spawn = function() {
      ...
      return new ae(function(d) {
        function e(b) {
          var c = Wa(a.next).call(a, b);
          return c === Va ? d.onError(c.e) : void g(c);
        }
        function f(b) {
          var c = Wa(a.next).call(a, b);
          return c === Va ? d.onError(c.e) : void g(c);
        ...
        function g(a) {
          ...
          var c = U.call(b, a.value);
          Cc.isObservable(c) ? h.add(c.subscribe(e, f)) : f(new TypeError("type not supported"));
        }
        var h = new Ub;
        return Ua(a) && (a = a.apply(b, c)), a && Ua(a.next) ? (e(), h) : (d.onNext(a), d.onCompleted());
      });
    };
    Cc.start = function(a, b, c) {
      return Jd(a, b, c)();
    };
    var Jd = Cc.toAsync = function(a, b, c) {
      return fc(c) || (c = oc), function() {
        var d = arguments,
            e = new ee;
    ...
    Cc.fromCallback = function(a, b, c) {
      return function() {
    ...
    }, Cc.fromNodeCallback = function(a, b, c) {
      return function() {
        "undefined" == typeof b && (b = this);
        for (var d = arguments.length,
            e = new Array(d),
    ...
    }, Ma.config.useNativeEvents = !1, Cc.fromEvent = function(a, b, c) {
      return a.addListener ? Kd(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : Ma.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new ae(function(d) {
        return ia(a, b, function() {
          var a = arguments[0];
          return Ua(c) && (a = Wa(c).apply(null, arguments), a === Va) ? d.onError(a.e) : void d.onNext(a);
        });
      }).publish().refCount() : Kd(function(c) {
        a.on(b, c);
      }, function(c) {
        a.off(b, c);
      }, c);
    };
    var Kd = Cc.fromEventPattern = function(a, b, c, d) {
      return fc(d) || (d = jc), new ae(function(d) {
        function e() {
          var a = arguments[0];
          return Ua(c) && (a = Wa(c).apply(null, arguments), a === Va) ? d.onError(a.e) : void d.onNext(a);
        }
    ...
    var Ld = function(a) {
      ...
      function c(c, d) {
        this.source = c, this.controller = new de, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, a.call(this, b, c);
      }
      return Nb(c, a), c.prototype.pause = function() {
        this.controller.onNext(!1);
      }, c.prototype.resume = function() {
        this.controller.onNext(!0);
      }, c;
    }(Cc);
    wc.pausable = function(a) {
    ...
    var Md = function(b) {
      ...
      function d(a, d) {
        this.source = a, this.controller = new de, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, b.call(this, c, a);
      }
      return Nb(d, b), d.prototype.pause = function() {
        this.controller.onNext(!1);
      }, d.prototype.resume = function() {
        this.controller.onNext(!0);
      }, d;
    }(Cc);
    wc.pausableBuffered = function(a) {
    ...
    var Nd = function(a) {
      ...
      function c(c, d, e) {
        a.call(this, b, c), this.subject = new Od(d, e), this.source = c.multicast(this.subject).refCount();
      }
      return Nb(c, a), c.prototype.request = function(a) {
        ...
        Od = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new de, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = null, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || kc;
          }
          return Nb(c, a), Ob(c.prototype, uc, {
            onCompleted: function() {
            ...
            request: function(a) {
              ...
              return this.requestedDisposable = this.scheduler.scheduleWithState(a, function(a, c) {
                ...
                return !e && d > 0 ? (b.requestedCount = d, Xb(function() {
                  b.requestedCount = 0;
                })) : void 0;
    ...
    wc.controlled = function(a, b) {
      return a && fc(a) && (b = a, a = !0), null == a && (a = !0), new Nd(this, a, b);
    };
    var Pd = function(a) {
      function b(a) {
        this.subscription = this.source.subscribe(new d(a, this, this.subscription));
        var b = this;
        return oc.schedule(function() {
          b.source.request(1);
        }), this.subscription;
      }
      function c(c) {
    ...
    Nd.prototype.stopAndWait = function() {
      return new Pd(this);
    };
    var Qd = function(a) {
      function b(a) {
    ...
    Nd.prototype.windowed = function(a) {
    ...
    }, wc.multicast = function(a, b) {
      var c = this;
      return "function" == typeof a ? new ae(function(d) {
        var e = c.multicast(a());
        return new Ub(b(e).subscribe(d), e.connect());
      }, c) : new Ud(c, a);
    }, wc.publish = function(a) {
      return a && Ua(a) ? this.multicast(function() {
        return new de;
      }, a) : this.multicast(new de);
    }, wc.share = function() {
      return this.publish().refCount();
    }, wc.publishLast = function(a) {
      return a && Ua(a) ? this.multicast(function() {
        return new ee;
      }, a) : this.multicast(new ee);
    }, wc.publishValue = function(a, b) {
      return 2 === arguments.length ? this.multicast(function() {
        return new Sd(b);
      }, a) : this.multicast(new Sd(a));
    }, wc.shareValue = function(a) {
      return this.publishValue(a).refCount();
    }, wc.replay = function(a, b, c, d) {
      return a && Ua(a) ? this.multicast(function() {
        return new Td(b, c, d);
      }, a) : this.multicast(new Td(b, c, d));
    }, wc.shareReplay = function(a, b, c) {
    ...
    var Sd = Ma.BehaviorSubject = function(a) {
      function c(a) {
        return $b(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), Yb) : (this.observers.push(a), a.onNext(this.value), new Rd(this, a));
      }
      function d(b) {
        a.call(this, c), this.value = b, this.observers = [], this.isDisposed = !1, this.isStopped = !1, this.hasError = !1;
      }
      return Nb(d, a), Ob(d.prototype, uc, {
        getValue: function() {
          if ($b(this), this.hasError)
            throw this.error;
          return this.value;
        },
        ...
        Td = Ma.ReplaySubject = function(a) {
          function c(a, b) {
            return Xb(function() {
          ...
          function d(a) {
            var b = new Ac(this.scheduler, a),
                d = c(this, b);
            $b(this), this._trim(this.scheduler.now()), this.observers.push(b);
            for (var e = 0,
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || kc, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
          var f = Math.pow(2, 53) - 1;
          return Nb(e, a), Ob(e.prototype, uc.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
        ...
        Ud = Ma.ConnectableObservable = function(a) {
          ...
          return Nb(b, a), b.prototype.refCount = function() {
            var a,
                b = 0,
                c = this;
            return new ae(function(d) {
    ...
    wc.singleInstance = function() {
      ...
      return new ae(function(f) {
        ...
        return g.add(e.subscribe(function(a) {
          ...
          l.set(c, a), g.add(e);
          var i = Wa(b)(a);
          return i === Va ? f.onError(i.e) : (e.setDisposable(i.take(1).subscribe(Na, n, function() {
            l["delete"](c) && 0 === l.size && h && f.onCompleted(), g.remove(e);
          })), void m.forEach(function(b) {
            var c = Wa(d)(a, b);
            return c === Va ? f.onError(c.e) : void f.onNext(c);
          }));
        }, n, function() {
          ...
          m.set(b, a), g.add(e);
          var h = Wa(c)(a);
          return h === Va ? f.onError(h.e) : (e.setDisposable(h.take(1).subscribe(Na, n, function() {
      ...
      return new ae(function(f) {
        ...
        return h.add(e.subscribe(function(a) {
          ...
          h.add(n);
          var o = Wa(b)(a);
          return o === Va ? (j.forEach(g(o.e)), f.onError(o.e)) : void n.setDisposable(o.take(1).subscribe(Na, function(a) {
          ...
          h.add(d);
          var e = Wa(c)(a);
          return e === Va ? (j.forEach(g(e.e)), f.onError(e.e)) : (d.setDisposable(e.take(1).subscribe(Na, function(a) {
            j.forEach(g(a)), f.onError(a);
          }, function() {
    ...
    wc.letBind = wc.let = function(a) {
      return a(this);
    }, Cc["if"] = function(a, b, c) {
      return Pc(function() {
        return c || (c = Sc()), Ta(b) && (b = Nc(b)), Ta(c) && (c = Nc(c)), "function" == typeof c.now && (c = Sc(c)), a() ? b : c;
      });
    }, Cc["for"] = Cc.forIn = function(a, b, c) {
      return Lc(a, b, c).concat();
    };
    var Wd = Cc["while"] = Cc.whileDo = function(a, b) {
      return Ta(b) && (b = Nc(b)), na(a, b).concat();
    };
    wc.doWhile = function(a) {
      return ld([this, Wd(a, this)]);
    }, Cc["case"] = function(a, b, c) {
      return Pc(function() {
        Ta(c) && (c = Nc(c)), c || (c = Sc()), fc(c) && (c = Sc(c));
        var d = b[a()];
        return Ta(d) && (d = Nc(d)), d || c;
      });
    }, wc.expand = function(a, b) {
      fc(b) || (b = jc);
      var c = this;
      return new ae(function(d) {
        var e = [],
      ...
      return new ae(function(b) {
        ...
        for (var d = new Ub,
          ...
          !function(i) {
            var j = a[i];
            Ta(j) && (j = Nc(j)), d.add(j.subscribe(function(a) {
              e || (f[i] = !0, h[i] = a);
            }, function(a) {
      ...
      return new ae(function(d) {
        var e,
            ...
            k = new _b,
            l = new _b;
        return Ta(a) && (a = Nc(a)), k.setDisposable(c.subscribe(function(a) {
          i = !0, e = a;
        }, function(a) {
    ...
    }, wc.manySelect = wc.extend = function(a, b) {
      fc(b) || (b = jc);
      var c = this;
      return Pc(function() {
        var d;
    ...
    var Xd = function(a) {
      ...
      function c(c) {
        a.call(this, b), this.head = c, this.tail = new ee;
      }
      return Nb(c, a), Ob(c.prototype, uc, {
        onCompleted: function() {
          this.onNext(Cc.empty());
        },
        onError: function(a) {
          this.onNext(Cc["throw"](a));
        },
        onNext: function(a) {
    ...
    oa.prototype.and = function(a) {
      ...
      for (var d = this,
        ...
        e.push(qa(a, this.expression.patterns[f], b.onError.bind(b)));
      var h = new ra(e, function() {
        var a;
        try {
      ...
      for (f = 0, g = e.length; g > f; f++)
        e[f].addActivePlan(h);
      return h;
    }, ra.prototype.dequeue = function() {
      this.joinObservers.forEach(function(a) {
        a.queue.shift();
      });
    }, ra.prototype.match = function() {
      var a,
          b,
          c = !0;
    ...
    var Zd = function(a) {
      ...
      }, c.error = Na, c.completed = Na, c.addActivePlan = function(a) {
    ...
    var $d = Cc.interval = function(a, b) {
      return va(a, a, fc(b) ? b : oc);
    };
    Cc.timer = function(b, c, d) {
      var e;
      return fc(d) || (d = oc), null != c && "number" == typeof c ? e = c : fc(c) && (d = c), b instanceof Date && e === a ? sa(b.getTime(), d) : b instanceof Date && e !== a ? ta(b.getTime(), c, d) : e === a ? ua(b, d) : va(b, e, d);
    };
    wc.delay = function() {
      if ("number" == typeof arguments[0] || arguments[0] instanceof Date) {
        var a = arguments[0],
            b = arguments[1];
        return fc(b) || (b = oc), a instanceof Date ? xa(this, a, b) : wa(this, a, b);
      }
      if (Ua(arguments[0]))
        return ya(this, arguments[0], arguments[1]);
      throw new Error("Invalid arguments");
    }, wc.debounce = function() {
      if (Ua(arguments[0]))
        return Aa(this, arguments[0]);
      if ("number" == typeof arguments[0])
        return za(this, arguments[0], arguments[1]);
      throw new Error("Invalid arguments");
    }, wc.windowWithTime = function(a, b, c) {
      var d,
          e = this;
      return null == b && (d = a), fc(c) || (c = oc), "number" == typeof b ? d = b : fc(b) && (d = a, c = b), new ae(function(b) {
        function f() {
          var a = new _b,
              e = !1,
              g = !1;
        ...
        var g,
            ...
            l = new ac,
            m = 0;
        return g = new Ub(l), h = new bc(g), k.push(new de), b.onNext(Pb(k[0], h)), f(), g.add(e.subscribe(function(a) {
          for (var b = 0,
              c = k.length; c > b; b++)
            k[b].onNext(a);
        }, function(a) {
    ...
    }, wc.windowWithTimeOrCount = function(a, b, c) {
      var d = this;
      return fc(c) || (c = oc), new ae(function(e) {
        function f(b) {
          var d = new _b;
          g.setDisposable(d), d.setDisposable(c.scheduleWithRelative(a, function() {
            if (b === k) {
              j = 0;
              var a = ++k;
              l.onCompleted(), l = new de, e.onNext(Pb(l, i)), f(a);
            }
          }));
        }
        var g = new ac,
            ...
            k = 0,
            l = new de;
        return e.onNext(Pb(l, i)), f(0), h.add(d.subscribe(function(a) {
          var c = 0,
              d = !1;
          l.onNext(a), ++j === b && (d = !0, j = 0, c = ++k, l.onCompleted(), l = new de, e.onNext(Pb(l, i))), d && f(c);
        }, function(a) {
    ...
    }, wc.bufferWithTime = function(a, b, c) {
      return this.windowWithTime(a, b, c).flatMap(L);
    }, wc.bufferWithTimeOrCount = function(a, b, c) {
      return this.windowWithTimeOrCount(a, b, c).flatMap(L);
    }, wc.timeInterval = function(a) {
      var b = this;
      return fc(a) || (a = oc), Pc(function() {
        var c = a.now();
    ...
    }, wc.timestamp = function(a) {
      return fc(a) || (a = oc), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      });
    }, wc.sample = wc.throttleLatest = function(a, b) {
      return fc(b) || (b = oc), "number" == typeof a ? Ba(this, $d(a, b)) : Ba(this, a);
    };
    var _d = Ma.TimeoutError = function(a) {
      this.message = a || "Timeout has occurred", this.name = "TimeoutError", Error.call(this);
    };
    _d.prototype = Object.create(Error.prototype), wc.timeout = function() {
      var a = arguments[0];
      if (a instanceof Date || "number" == typeof a)
        return Da(this, a, arguments[1], arguments[2]);
      if (Cc.isObservable(a) || Ua(a))
        return Ca(this, a, arguments[1], arguments[2]);
      throw new Error("Invalid arguments");
    }, Cc.generateWithAbsoluteTime = function(a, b, c, d, e, f) {
      return fc(f) || (f = oc), new ae(function(g) {
        var h = !0,
            i = !1;
    ...
    }, Cc.generateWithRelativeTime = function(a, b, c, d, e, f) {
      return fc(f) || (f = oc), new ae(function(g) {
        var h = !0,
            i = !1;
    ...
    }, wc.takeLastWithTime = function(a, b) {
      var c = this;
      return fc(b) || (b = oc), new ae(function(d) {
        var e = [];
        return c.subscribe(function(c) {
          var d = b.now();
          for (e.push({
    ...
    }, wc.takeLastBufferWithTime = function(a, b) {
      var c = this;
      return fc(b) || (b = oc), new ae(function(d) {
        var e = [];
        return c.subscribe(function(c) {
    ...
    }, wc.takeWithTime = function(a, b) {
      var c = this;
      return fc(b) || (b = oc), new ae(function(d) {
        return new Ub(b.scheduleWithRelative(a, function() {
          d.onCompleted();
        }), c.subscribe(d));
      }, c);
    }, wc.skipWithTime = function(a, b) {
      var c = this;
      return fc(b) || (b = oc), new ae(function(d) {
        var e = !1;
        return new Ub(b.scheduleWithRelative(a, function() {
    ...
    }, wc.skipUntilWithTime = function(a, b) {
      fc(b) || (b = oc);
      var c = this,
          d = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new ae(function(e) {
        var f = !1;
        return new Ub(b[d](a, function() {
          f = !0;
        }), c.subscribe(function(a) {
          f && e.onNext(a);
        }, function(a) {
    ...
    }, wc.takeUntilWithTime = function(a, b) {
      fc(b) || (b = oc);
      var c = this,
          d = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new ae(function(e) {
    ...
    }, wc.flatMapFirst = wc.selectManyFirst = function(a, b, c) {
      return new Ec(this, a, b, c).switchFirst();
    }, Ma.Observable.prototype.flatMapWithMaxConcurrent = function(a, b, c, d) {
      return new Ec(this, b, c, d).merge(a);
    }, wc.transduce = function(a) {
      function b(a) {
        return {
      ...
      return new ae(function(d) {
        var e = a(b(d));
        return c.subscribe(function(a) {
          var b = Wa(e["@@transducer/step"]).call(e, d, a);
          b === Va && d.onError(b.e);
        }, function(a) {
          d.onError(a);
        }, function() {
    ...
    Ma.VirtualTimeScheduler = function(a) {
      function b() {
      ...
      function g(f, g) {
        this.clock = f, this.comparer = g, this.isEnabled = !1, this.queue = new Sb(1024), a.call(this, b, c, d, e);
      }
      Nb(g, a);
      var h = g.prototype;
      return h.add = fb, h.toDateTimeOffset = fb, h.toRelative = fb, h.schedulePeriodicWithState = function(a, b, c) {
        ...
        var e = this,
            f = new cc(this, a, d, b, this.comparer);
        return this.queue.enqueue(f), f.disposable;
      }, g;
    }(dc);
    Ma.HistoricalScheduler = function(a) {
      function b(b, c) {
        var d = null == b ? 0 : b,
            e = c || Ra;
        a.call(this, d, e);
    ...
    }(Ma.VirtualTimeScheduler);
    var ae = Ma.AnonymousObservable = function(a) {
      function b(a) {
        return a && Ua(a.dispose) ? a : Ua(a) ? Xb(a) : Yb;
      }
      function c(a, c) {
      ...
      return Nb(f, a), f;
        ...
        ce = function(a) {
          ...
          function c(c, d, e) {
            a.call(this, b), this.key = c, this.underlyingObservable = e ? new ae(function(a) {
              return new Ub(e.getDisposable(), d.subscribe(a));
            }) : d;
          }
          return Nb(c, a), c;
        }(Cc),
        de = Ma.Subject = function(a) {
          function c(a) {
            return $b(this), this.isStopped ? this.hasError ? (a.onError(this.error), Yb) : (a.onCompleted(), Yb) : (this.observers.push(a), new Rd(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
          }
          return Nb(d, a), Ob(d.prototype, uc.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            onCompleted: function() {
        ...
        ee = Ma.AsyncSubject = function(a) {
          function c(a) {
            return $b(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), Yb) : (this.observers.push(a), new Rd(this, a));
          }
          function d() {
          ...
          return Nb(d, a), Ob(d.prototype, uc, {
            hasObservers: function() {
              return $b(this), this.observers.length > 0;
            },
            onCompleted: function() {
              var a,
                  c;
            ...
            onNext: function(a) {
              $b(this), this.isStopped || (this.value = a, this.hasValue = !0);
            },
            dispose: function() {
        ...
        fe = Ma.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return Nb(c, a), Ob(c.prototype, uc.prototype, {
            onCompleted: function() {
    ...
    Ma.Pauser = function(a) {
      ...
      return Nb(b, a), b.prototype.pause = function() {
        this.onNext(!1);
      }, b.prototype.resume = function() {
        this.onNext(!0);
      }, b;
    }(de), "function" == typeof define && "object" == typeof define.amd && define.amd ? (La.Rx = Ma, define(function() {
      return Ma;
